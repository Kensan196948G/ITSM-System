...
|-------------|---------------------|---------|
| Brave Search API Key | `***REDACTED_BRAVE_API_KEY***` | ⛔ 即座に無効化必要 |
| Context7 API Key | `***REDACTED_CONTEXT7_API_KEY***` | ⛔ 即座に無効化必要 |
...
2. 「API Keys」セクションで `***REDACTED_BRAVE_API_KEY***` を**Revoke（無効化）**
3. 新しいAPIキーを生成
...
2. 「Settings」→「API Keys」で `***REDACTED_CONTEXT7_API_KEY***` を**Delete**
3. 新しいAPIキーを生成
4. 新しいキーを安全な場所に保存
