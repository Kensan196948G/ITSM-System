...
# → API Keys → ***REDACTED_BRAVE_API_KEY*** を Revoke

# 2. Context7 API
# Context7ダッシュボードにアクセス
# → API Keys → ***REDACTED_CONTEXT7_API_KEY*** を Delete
...
```bash
# GitHubで公開リポジトリを検索
# https://github.com/search?q=***REDACTED_BRAVE_API_KEY***&type=code
# https://github.com/search?q=***REDACTED_CONTEXT7_API_KEY***&type=code
```
...
# 特定のキーが含まれているか確認
git grep -i "***REDACTED_BRAVE_API_KEY***" $(git rev-list --all)
```
