...
```json
{
  "timestamp": "2026-02-24T11:16:27.291132",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 7.5,
      "message": "Memory usage normal: 7.5%",
      "critical": false,
      "details": {
        "total_mb": 15994,
        "used_mb": 1201,
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 257831037,
      "bytes_sent": 2729432,
      "bytes_received_mb": 245.89,
      "bytes_sent_mb": 2.6
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 7.538 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.075 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.778 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.443 ms - 7281[0m
  console.log
