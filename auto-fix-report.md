...
```json
{
  "timestamp": "2026-02-03T11:48:33.157997",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 5.2,
      "message": "Memory usage normal: 5.2%",
      "critical": false,
      "details": {
        "total_mb": 15994,
        "used_mb": 831,
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.353 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 20.337 ms - 7278[0m
  console.log
