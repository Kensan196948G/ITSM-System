...
```json
{
  "timestamp": "2026-02-25T09:12:34.541737",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 279197421,
      "bytes_sent": 2421455,
      "bytes_received_mb": 266.26,
      "bytes_sent_mb": 2.31
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.426 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.620 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.832 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 7.012 ms - 1516[0m
