...
```json
{
  "timestamp": "2026-02-14T08:34:04.638590",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 138944032,
      "bytes_sent": 1018230,
      "bytes_received_mb": 132.51,
      "bytes_sent_mb": 0.97
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.136 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.561 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.459 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.258 ms - 1516[0m
