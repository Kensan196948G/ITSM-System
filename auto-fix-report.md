...
```json
{
  "timestamp": "2026-02-03T21:19:20.302803",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 107647675,
      "bytes_sent": 971513,
      "bytes_received_mb": 102.66,
      "bytes_sent_mb": 0.93
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 10.544 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 72.469 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 13.981 ms - 1516[0m
