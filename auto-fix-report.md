...
```json
{
  "timestamp": "2026-02-12T04:25:15.872266",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 276279055,
      "bytes_sent": 2659789,
      "bytes_received_mb": 263.48,
      "bytes_sent_mb": 2.54
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.353 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.890 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.853 ms - 7275[0m
  console.log
