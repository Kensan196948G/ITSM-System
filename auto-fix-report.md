...
```json
{
  "timestamp": "2026-02-26T06:31:51.241142",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 275760460,
      "bytes_sent": 2738810,
      "bytes_received_mb": 262.99,
      "bytes_sent_mb": 2.61
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 7.492 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.562 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.290 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.581 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 7.449 ms - 1516[0m
