...
```json
{
  "timestamp": "2026-02-28T09:56:16.681746",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 732999314,
      "bytes_sent": 6034858,
      "bytes_received_mb": 699.04,
      "bytes_sent_mb": 5.76
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (8.974 s)
