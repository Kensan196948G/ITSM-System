...
```json
{
  "timestamp": "2026-03-01T11:52:16.115016",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 723632951,
      "bytes_sent": 4424615,
      "bytes_received_mb": 690.11,
      "bytes_sent_mb": 4.22
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.566 s)
