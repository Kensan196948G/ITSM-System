...
```json
{
  "timestamp": "2026-02-12T08:48:30.374071",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 274852276,
      "bytes_sent": 1757478,
      "bytes_received_mb": 262.12,
      "bytes_sent_mb": 1.68
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.148 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.094 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.157 ms - 1516[0m
