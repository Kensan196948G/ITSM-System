...
```json
{
  "timestamp": "2026-02-28T06:17:44.986000",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 135319032,
      "bytes_sent": 1053770,
      "bytes_received_mb": 129.05,
      "bytes_sent_mb": 1.0
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (8.994 s)
