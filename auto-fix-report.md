...
```json
{
  "timestamp": "2026-02-28T20:48:49.683504",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 474168421,
      "bytes_sent": 3330774,
      "bytes_received_mb": 452.2,
      "bytes_sent_mb": 3.18
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.506 s)
...
FAIL backend/__tests__/unit/utils/encryption.test.js
  ● Encryption Utility (AES-256-GCM) › decrypt › should throw on tampered auth tag

    expect(received).toThrow()

    Received function did not throw

    [0m [90m 124 |[39m       [90m// Tamper with the auth tag[39m
     [90m 125 |[39m       [36mconst[39m tamperedTag [33m=[39m [32m`ff${authTag.slice(2)}`[39m[33m;[39m
    [31m[1m>[22m[39m[90m 126 |[39m       expect(() [33m=>[39m decrypt(encrypted[33m,[39m iv[33m,[39m tamperedTag[33m,[39m [33mTEST_KEY[39m))[33m.[39mtoThrow()[33m;[39m
     [90m     |[39m                                                                   [31m[1m^[22m[39m
     [90m 127 |[39m     })[33m;[39m
     [90m 128 |[39m
     [90m 129 |[39m     it([32m'should throw on wrong key'[39m[33m,[39m () [33m=>[39m {[0m

      at Object.toThrow (backend/__tests__/unit/utils/encryption.test.js:126:67)


Test Suites: 3 failed, 1 skipped, 78 passed, 81 of 82 total
Tests:       34 failed, 57 skipped, 2241 passed, 2332 total
Snapshots:   0 total
Time:        197.876 s
Ran all test suites.
