...
```json
{
  "timestamp": "2026-02-27T19:25:30.860927",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 726474512,
      "bytes_sent": 6058399,
      "bytes_received_mb": 692.82,
      "bytes_sent_mb": 5.78
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.262 s)
