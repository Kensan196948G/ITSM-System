...
```json
{
  "timestamp": "2026-02-21T00:02:25.015190",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 282800024,
      "bytes_sent": 3124085,
      "bytes_received_mb": 269.7,
      "bytes_sent_mb": 2.98
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.496 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.860 ms - 7278[0m
  console.log
