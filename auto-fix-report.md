...
```json
{
  "timestamp": "2026-02-23T10:57:56.822238",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 257402536,
      "bytes_sent": 2459555,
      "bytes_received_mb": 245.48,
      "bytes_sent_mb": 2.35
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.696 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.156 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.580 ms - 1516[0m
