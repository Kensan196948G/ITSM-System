...
```json
{
  "timestamp": "2026-02-27T22:31:28.989243",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 238897996,
      "bytes_sent": 2555907,
      "bytes_received_mb": 227.83,
      "bytes_sent_mb": 2.44
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.717 s)
