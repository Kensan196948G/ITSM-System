...
```json
{
  "timestamp": "2026-02-10T10:38:35.302962",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 275226831,
      "bytes_sent": 2339269,
      "bytes_received_mb": 262.48,
      "bytes_sent_mb": 2.23
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.841 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.420 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.999 ms - 1516[0m
