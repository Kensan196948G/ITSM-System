...
```json
{
  "timestamp": "2026-02-19T20:40:07.319682",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 144614286,
      "bytes_sent": 1475989,
      "bytes_received_mb": 137.91,
      "bytes_sent_mb": 1.41
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.400 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.702 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.053 ms - 7278[0m
  console.log
