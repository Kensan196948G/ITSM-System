...
```json
{
  "timestamp": "2026-02-18T17:02:29.413586",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 7.1,
      "message": "Memory usage normal: 7.1%",
      "critical": false,
      "details": {
        "total_mb": 15990,
        "used_mb": 1128,
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140063381,
      "bytes_sent": 1047626,
      "bytes_received_mb": 133.57,
      "bytes_sent_mb": 1.0
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.489 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.769 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.405 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.588 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.067 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    GET /api/v1/export/incidents
      ✓ 認証なしで401エラー (5 ms)
      ✓ CSV形式でインシデントエクスポート（200） (17 ms)
