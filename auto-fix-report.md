...
```json
{
  "timestamp": "2026-03-02T04:28:44.963650",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 496968374,
      "bytes_sent": 2266959,
      "bytes_received_mb": 473.95,
      "bytes_sent_mb": 2.16
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.124 s)
...
Tests:       33 failed, 24 skipped, 2459 passed, 2516 total
Snapshots:   0 total
Time:        203.715 s
Ran all test suites.
