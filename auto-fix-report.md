...
```json
{
  "timestamp": "2026-02-22T09:56:32.724391",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 257548833,
      "bytes_sent": 2300179,
      "bytes_received_mb": 245.62,
      "bytes_sent_mb": 2.19
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.581 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.666 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.946 ms - 7279[0m
  console.log
