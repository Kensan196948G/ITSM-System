...
```json
{
  "timestamp": "2026-02-28T17:24:02.342796",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 731343037,
      "bytes_sent": 5496815,
      "bytes_received_mb": 697.46,
      "bytes_sent_mb": 5.24
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.354 s)
