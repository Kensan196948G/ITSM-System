...
```json
{
  "timestamp": "2026-02-23T23:22:33.978813",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 257704628,
      "bytes_sent": 2432030,
      "bytes_received_mb": 245.77,
      "bytes_sent_mb": 2.32
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.510 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.619 ms - 7277[0m
  console.log
