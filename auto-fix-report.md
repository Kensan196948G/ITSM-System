...
```json
{
  "timestamp": "2026-02-06T15:43:05.992032",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 273633951,
      "bytes_sent": 2558413,
      "bytes_received_mb": 260.96,
      "bytes_sent_mb": 2.44
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 10.982 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 55.495 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 14.377 ms - 1516[0m
