...
```json
{
  "timestamp": "2026-03-01T19:59:20.487072",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 707132006,
      "bytes_sent": 3896978,
      "bytes_received_mb": 674.37,
      "bytes_sent_mb": 3.72
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.595 s)
