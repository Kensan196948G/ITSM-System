...
```json
{
  "timestamp": "2026-03-01T12:41:02.496289",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 713414392,
      "bytes_sent": 4715434,
      "bytes_received_mb": 680.36,
      "bytes_sent_mb": 4.5
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.58 s)
