...
```json
{
  "timestamp": "2026-02-03T01:11:55.394159",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 11.481 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 64.560 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 14.396 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    ...
    GET /api/v1/export/assets
      ✓ CSV形式で資産エクスポート（200） (18 ms)
      ✓ Excel形式で資産エクスポート（200） (78 ms)
