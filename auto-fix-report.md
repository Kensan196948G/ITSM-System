...
```json
{
  "timestamp": "2026-02-28T15:14:24.075505",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 488689736,
      "bytes_sent": 3066558,
      "bytes_received_mb": 466.05,
      "bytes_sent_mb": 2.92
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.494 s)
