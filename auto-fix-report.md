...
```json
{
  "timestamp": "2026-02-02T09:31:20.704443",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105955213,
      "bytes_sent": 674214,
      "bytes_received_mb": 101.05,
      "bytes_sent_mb": 0.64
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.468 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.310 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.618 ms - 1516[0m
...
PASS backend/__tests__/unit/middleware/cache.test.js
  Cache Middleware
    ✓ generateCacheKey sorts query params (10 ms)
...
PASS backend/__tests__/unit/middleware/metrics.test.js
  Metrics Middleware Helpers
    ✓ updates custom metrics without errors (17 ms)
