...
```json
{
  "timestamp": "2026-02-13T23:36:07.178158",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 138707382,
      "bytes_sent": 860957,
      "bytes_received_mb": 132.28,
      "bytes_sent_mb": 0.82
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.266 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.008 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.536 ms - 7275[0m
  console.log
