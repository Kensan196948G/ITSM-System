...
```json
{
  "timestamp": "2026-02-22T11:27:10.022320",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 253198803,
      "bytes_sent": 4272796,
      "bytes_received_mb": 241.47,
      "bytes_sent_mb": 4.07
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 9.994 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.037 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.737 ms - 7273[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.463 ms - 1516[0m
