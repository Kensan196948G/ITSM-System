...
```json
{
  "timestamp": "2026-02-09T21:52:08.100590",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140970511,
      "bytes_sent": 1759147,
      "bytes_received_mb": 134.44,
      "bytes_sent_mb": 1.68
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 9.148 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.535 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.050 ms - 7275[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.204 ms - 1516[0m
