...
```json
{
  "timestamp": "2026-02-28T11:44:17.660786",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 369307760,
      "bytes_sent": 1338144,
      "bytes_received_mb": 352.2,
      "bytes_sent_mb": 1.28
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.346 s)
