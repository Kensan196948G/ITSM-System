...
```json
{
  "timestamp": "2026-02-05T00:02:21.635802",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 208149010,
      "bytes_sent": 2114456,
      "bytes_received_mb": 198.51,
      "bytes_sent_mb": 2.02
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 25.284 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 43.068 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 12.023 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    GET /api/v1/export/incidents
      ...
      ✓ Excel形式でインシデントエクスポート（200） (84 ms)
