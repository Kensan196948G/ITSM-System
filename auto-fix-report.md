...
```json
{
  "timestamp": "2026-02-19T07:34:37.740258",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 142562985,
      "bytes_sent": 1079530,
      "bytes_received_mb": 135.96,
      "bytes_sent_mb": 1.03
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 9.198 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.015 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.409 ms - 7281[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.378 ms - 1516[0m
