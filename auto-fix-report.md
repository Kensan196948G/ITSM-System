...
```json
{
  "timestamp": "2026-02-15T22:26:18.813914",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 8.8,
      "message": "Memory usage normal: 8.8%",
      "critical": false,
      "details": {
        "total_mb": 15989,
        "used_mb": 1406,
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 272919552,
      "bytes_sent": 1803950,
      "bytes_received_mb": 260.28,
      "bytes_sent_mb": 1.72
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.609 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.860 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.213 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.554 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.475 ms - 1516[0m
