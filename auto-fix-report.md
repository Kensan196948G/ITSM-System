...
```json
{
  "timestamp": "2026-02-23T08:04:11.598957",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 283413227,
      "bytes_sent": 4003387,
      "bytes_received_mb": 270.28,
      "bytes_sent_mb": 3.82
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.117 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.537 ms - 7275[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.962 ms - 1516[0m
