...
```json
{
  "timestamp": "2026-02-28T10:42:16.978208",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 730890757,
      "bytes_sent": 5400963,
      "bytes_received_mb": 697.03,
      "bytes_sent_mb": 5.15
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.52 s)
