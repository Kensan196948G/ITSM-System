...
```json
{
  "timestamp": "2026-02-19T14:57:11.258640",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 142578756,
      "bytes_sent": 1027526,
      "bytes_received_mb": 135.97,
      "bytes_sent_mb": 0.98
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.910 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.836 ms - 7278[0m
  console.log
