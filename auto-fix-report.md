...
```json
{
  "timestamp": "2026-02-28T23:51:27.694437",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 718369102,
      "bytes_sent": 5334326,
      "bytes_received_mb": 685.09,
      "bytes_sent_mb": 5.09
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.719 s)
