...
```json
{
  "timestamp": "2026-02-04T01:58:00.692874",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105918269,
      "bytes_sent": 849143,
      "bytes_received_mb": 101.01,
      "bytes_sent_mb": 0.81
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 11.326 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 72.033 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 17.428 ms - 1516[0m
