...
```json
{
  "timestamp": "2026-02-26T23:04:04.850423",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 8.4,
      "message": "Memory usage normal: 8.4%",
      "critical": false,
      "details": {
        "total_mb": 15990,
        "used_mb": 1338,
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 275167250,
      "bytes_sent": 2219820,
      "bytes_received_mb": 262.42,
      "bytes_sent_mb": 2.12
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.105 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.531 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 7.335 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.509 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.967 ms - 1516[0m
