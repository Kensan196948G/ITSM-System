...
```json
{
  "timestamp": "2026-03-01T04:32:51.407025",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 731247021,
      "bytes_sent": 4582395,
      "bytes_received_mb": 697.37,
      "bytes_sent_mb": 4.37
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.584 s)
