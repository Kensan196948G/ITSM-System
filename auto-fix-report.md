...
```json
{
  "timestamp": "2026-02-10T00:04:53.708374",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 274871593,
      "bytes_sent": 1723747,
      "bytes_received_mb": 262.14,
      "bytes_sent_mb": 1.64
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.041 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.060 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.019 ms - 7274[0m
  console.log
