...
```json
{
  "timestamp": "2026-02-26T09:32:11.549563",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 276760353,
      "bytes_sent": 2822549,
      "bytes_received_mb": 263.94,
      "bytes_sent_mb": 2.69
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.572 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.536 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.796 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.959 ms - 1516[0m
