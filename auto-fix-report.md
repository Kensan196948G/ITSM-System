...
```json
{
  "timestamp": "2026-02-02T13:50:57.321053",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105863005,
      "bytes_sent": 861264,
      "bytes_received_mb": 100.96,
      "bytes_sent_mb": 0.82
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 25.717 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 43.280 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 10.906 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    ...
    GET /api/v1/export/vulnerabilities
      ...
      ✓ JSON形式で脆弱性エクスポート（200） (37 ms)
    GET /api/v1/export/changes
      ✓ CSV形式で変更管理エクスポート（200） (40 ms)
    GET /api/v1/export/assets
      ✓ CSV形式で資産エクスポート（200） (39 ms)
      ✓ Excel形式で資産エクスポート（200） (58 ms)
    Export with date filters
      ✓ 日付フィルタ付きでエクスポート (37 ms)
