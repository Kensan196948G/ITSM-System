...
```json
{
  "timestamp": "2026-03-01T06:25:42.335238",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 369565302,
      "bytes_sent": 1391159,
      "bytes_received_mb": 352.44,
      "bytes_sent_mb": 1.33
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.713 s)
