...
```json
{
  "timestamp": "2026-02-21T05:10:35.893856",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 257030873,
      "bytes_sent": 2371111,
      "bytes_received_mb": 245.12,
      "bytes_sent_mb": 2.26
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.691 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.559 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.613 ms - 7276[0m
  console.log
