...
```json
{
  "timestamp": "2026-02-21T16:00:58.599361",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 224641901,
      "bytes_sent": 1714162,
      "bytes_received_mb": 214.24,
      "bytes_sent_mb": 1.63
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.589 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.122 ms - 7275[0m
  console.log
