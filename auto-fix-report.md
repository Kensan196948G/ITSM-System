...
```json
{
  "timestamp": "2026-02-11T08:23:37.242250",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 142012765,
      "bytes_sent": 1360158,
      "bytes_received_mb": 135.43,
      "bytes_sent_mb": 1.3
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.649 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.945 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.418 ms - 7278[0m
  console.log
