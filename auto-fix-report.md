...
```json
{
  "timestamp": "2026-02-02T05:15:09.413394",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105602822,
      "bytes_sent": 643050,
      "bytes_received_mb": 100.71,
      "bytes_sent_mb": 0.61
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 19.266 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 62.822 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 19.061 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    ...
    GET /api/v1/export/vulnerabilities
      ✓ CSV形式で脆弱性エクスポート（200） (44 ms)
      ✓ JSON形式で脆弱性エクスポート（200） (43 ms)
    GET /api/v1/export/changes
      ✓ CSV形式で変更管理エクスポート（200） (37 ms)
    GET /api/v1/export/assets
      ✓ CSV形式で資産エクスポート（200） (37 ms)
      ✓ Excel形式で資産エクスポート（200） (72 ms)
    Export with date filters
      ✓ 日付フィルタ付きでエクスポート (23 ms)
