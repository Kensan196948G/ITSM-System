...
```json
{
  "timestamp": "2026-02-28T20:02:51.867563",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 473951244,
      "bytes_sent": 2751734,
      "bytes_received_mb": 452.0,
      "bytes_sent_mb": 2.62
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.568 s)
