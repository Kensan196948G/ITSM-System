...
```json
{
  "timestamp": "2026-02-04T09:05:44.390342",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106655518,
      "bytes_sent": 1339088,
      "bytes_received_mb": 101.71,
      "bytes_sent_mb": 1.28
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.120 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.145 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 8.240 ms - 1516[0m
