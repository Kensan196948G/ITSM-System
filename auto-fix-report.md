...
```json
{
  "timestamp": "2026-02-21T12:16:48.202926",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 254074941,
      "bytes_sent": 3623075,
      "bytes_received_mb": 242.3,
      "bytes_sent_mb": 3.46
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.734 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 8.605 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.459 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.255 ms - 1516[0m
