...
```json
{
  "timestamp": "2026-02-27T22:00:20.788685",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 473313124,
      "bytes_sent": 2515238,
      "bytes_received_mb": 451.39,
      "bytes_sent_mb": 2.4
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.366 s)
