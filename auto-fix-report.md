...
```json
{
  "timestamp": "2026-02-20T21:16:52.131003",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 6.4,
      "message": "Memory usage normal: 6.4%",
      "critical": false,
      "details": {
        "total_mb": 15994,
        "used_mb": 1031,
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 276789067,
      "bytes_sent": 2163875,
      "bytes_received_mb": 263.97,
      "bytes_sent_mb": 2.06
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.229 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.756 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.458 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.628 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.497 ms - 1516[0m
