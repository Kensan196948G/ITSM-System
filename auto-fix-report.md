...
```json
{
  "timestamp": "2026-03-01T19:24:17.993638",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 369431613,
      "bytes_sent": 1384531,
      "bytes_received_mb": 352.32,
      "bytes_sent_mb": 1.32
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.704 s)
