...
```json
{
  "timestamp": "2026-02-24T23:14:34.953431",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 253793368,
      "bytes_sent": 2361199,
      "bytes_received_mb": 242.04,
      "bytes_sent_mb": 2.25
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 8.442 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.373 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.285 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.500 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 8.141 ms - 1516[0m
