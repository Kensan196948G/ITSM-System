...
```json
{
  "timestamp": "2026-02-26T08:44:19.432857",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 176121164,
      "bytes_sent": 1288390,
      "bytes_received_mb": 167.96,
      "bytes_sent_mb": 1.23
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.168 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.118 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.583 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.085 ms - 1516[0m
