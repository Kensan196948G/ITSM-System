...
```json
{
  "timestamp": "2026-02-04T03:59:52.114321",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106260133,
      "bytes_sent": 691572,
      "bytes_received_mb": 101.34,
      "bytes_sent_mb": 0.66
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.586 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.863 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.360 ms - 1516[0m
