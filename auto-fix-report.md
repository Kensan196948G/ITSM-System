...
```json
{
  "timestamp": "2026-02-11T20:40:02.741673",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140978525,
      "bytes_sent": 1667849,
      "bytes_received_mb": 134.45,
      "bytes_sent_mb": 1.59
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.798 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.767 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.455 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.553 ms - 1516[0m
