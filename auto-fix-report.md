...
```json
{
  "timestamp": "2026-02-27T11:08:29.233674",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 250614302,
      "bytes_sent": 2134828,
      "bytes_received_mb": 239.0,
      "bytes_sent_mb": 2.04
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 22.389 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 7.024 ms - 1516[0m
