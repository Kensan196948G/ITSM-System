...
```json
{
  "timestamp": "2026-02-02T17:25:06.836220",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 209817652,
      "bytes_sent": 4485156,
      "bytes_received_mb": 200.1,
      "bytes_sent_mb": 4.28
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 12.703 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 69.974 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 22.317 ms - 1516[0m
