...
```json
{
  "timestamp": "2026-02-25T06:10:59.702602",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 254019714,
      "bytes_sent": 2226243,
      "bytes_received_mb": 242.25,
      "bytes_sent_mb": 2.12
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.377 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.426 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.783 ms - 7276[0m
  console.log
