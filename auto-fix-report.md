...
```json
{
  "timestamp": "2026-02-20T08:06:40.406373",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 274275980,
      "bytes_sent": 2379492,
      "bytes_received_mb": 261.57,
      "bytes_sent_mb": 2.27
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.267 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.235 ms - 7278[0m
  console.log
