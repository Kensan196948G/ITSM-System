...
```json
{
  "timestamp": "2026-02-09T22:09:04.011106",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 5.4,
      "message": "Memory usage normal: 5.4%",
      "critical": false,
      "details": {
        "total_mb": 15990,
        "used_mb": 865,
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.618 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.878 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.549 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.941 ms - 7272[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.628 ms - 1516[0m
