...
```json
{
  "timestamp": "2026-02-28T07:46:30.216679",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 706062295,
      "bytes_sent": 4958539,
      "bytes_received_mb": 673.35,
      "bytes_sent_mb": 4.73
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.596 s)
