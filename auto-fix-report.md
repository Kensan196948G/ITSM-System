...
```json
{
  "timestamp": "2026-02-25T21:10:05.895824",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 251684454,
      "bytes_sent": 2057443,
      "bytes_received_mb": 240.02,
      "bytes_sent_mb": 1.96
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.423 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.700 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.329 ms - 7273[0m
  console.log
