...
```json
{
  "timestamp": "2026-02-02T08:00:25.494766",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106001331,
      "bytes_sent": 1160583,
      "bytes_received_mb": 101.09,
      "bytes_sent_mb": 1.11
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.667 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 8.216 ms - 1516[0m
