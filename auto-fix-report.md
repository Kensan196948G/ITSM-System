...
```json
{
  "timestamp": "2026-02-28T20:17:09.456594",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 239565540,
      "bytes_sent": 3218856,
      "bytes_received_mb": 228.47,
      "bytes_sent_mb": 3.07
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.278 s)
