...
```json
{
  "timestamp": "2026-02-08T21:47:31.478886",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 274146080,
      "bytes_sent": 1640668,
      "bytes_received_mb": 261.45,
      "bytes_sent_mb": 1.56
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.380 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.026 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.606 ms - 7281[0m
  console.log
