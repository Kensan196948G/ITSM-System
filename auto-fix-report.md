...
```json
{
  "timestamp": "2026-02-14T09:22:01.046100",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 138585578,
      "bytes_sent": 850443,
      "bytes_received_mb": 132.17,
      "bytes_sent_mb": 0.81
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.558 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.873 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.276 ms - 7277[0m
  console.log
