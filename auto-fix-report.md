...
```json
{
  "timestamp": "2026-02-28T11:06:19.963765",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 488359968,
      "bytes_sent": 2767980,
      "bytes_received_mb": 465.74,
      "bytes_sent_mb": 2.64
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.679 s)
