...
```json
{
  "timestamp": "2026-02-18T23:13:34.180853",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140582286,
      "bytes_sent": 1112121,
      "bytes_received_mb": 134.07,
      "bytes_sent_mb": 1.06
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.722 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.578 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.146 ms - 7282[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.211 ms - 1516[0m
