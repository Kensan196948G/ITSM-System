...
```json
{
  "timestamp": "2026-02-28T08:59:19.703868",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 241003744,
      "bytes_sent": 3578637,
      "bytes_received_mb": 229.84,
      "bytes_sent_mb": 3.41
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.647 s)
