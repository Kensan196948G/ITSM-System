...
```json
{
  "timestamp": "2026-02-28T05:41:41.530206",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 137932045,
      "bytes_sent": 1260317,
      "bytes_received_mb": 131.54,
      "bytes_sent_mb": 1.2
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.255 s)
