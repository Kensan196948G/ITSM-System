...
```json
{
  "timestamp": "2026-02-21T19:12:24.589910",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 148289817,
      "bytes_sent": 1232415,
      "bytes_received_mb": 141.42,
      "bytes_sent_mb": 1.18
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.667 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.968 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.025 ms - 1516[0m
