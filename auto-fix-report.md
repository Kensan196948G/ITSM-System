...
```json
{
  "timestamp": "2026-02-05T15:05:19.581389",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139566028,
      "bytes_sent": 743894,
      "bytes_received_mb": 133.1,
      "bytes_sent_mb": 0.71
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 13.371 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 46.056 ms - 7288[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 13.026 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    ...
    GET /api/v1/export/vulnerabilities
      ...
      ✓ JSON形式で脆弱性エクスポート（200） (18 ms)
    GET /api/v1/export/changes
      ✓ CSV形式で変更管理エクスポート（200） (20 ms)
    GET /api/v1/export/assets
      ✓ CSV形式で資産エクスポート（200） (21 ms)
      ✓ Excel形式で資産エクスポート（200） (54 ms)
    Export with date filters
      ✓ 日付フィルタ付きでエクスポート (22 ms)
