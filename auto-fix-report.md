...
```json
{
  "timestamp": "2026-02-04T11:40:28.507441",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105825220,
      "bytes_sent": 656526,
      "bytes_received_mb": 100.92,
      "bytes_sent_mb": 0.63
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 24.010 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 41.638 ms - 7275[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 32.769 ms - 1516[0m
