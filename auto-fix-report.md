...
```json
{
  "timestamp": "2026-02-21T10:34:13.833027",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 257063744,
      "bytes_sent": 3550787,
      "bytes_received_mb": 245.16,
      "bytes_sent_mb": 3.39
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.870 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.842 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.780 ms - 1516[0m
