...
```json
{
  "timestamp": "2026-02-13T14:57:01.022245",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 8.5,
      "message": "Memory usage normal: 8.5%",
      "critical": false,
      "details": {
        "total_mb": 15993,
        "used_mb": 1367,
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 272231148,
      "bytes_sent": 2353806,
      "bytes_received_mb": 259.62,
      "bytes_sent_mb": 2.24
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.549 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.924 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.689 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.528 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.766 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    GET /api/v1/export/incidents
      ✓ 認証なしで401エラー (6 ms)
      ✓ CSV形式でインシデントエクスポート（200） (21 ms)
