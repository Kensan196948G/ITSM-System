...
```json
{
  "timestamp": "2026-02-26T00:01:29.917130",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 275794580,
      "bytes_sent": 2387934,
      "bytes_received_mb": 263.02,
      "bytes_sent_mb": 2.28
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.773 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.909 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.963 ms - 1516[0m
