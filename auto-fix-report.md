...
```json
{
  "timestamp": "2026-02-21T13:50:35.158322",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 281156112,
      "bytes_sent": 3895337,
      "bytes_received_mb": 268.13,
      "bytes_sent_mb": 3.71
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.063 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.506 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.531 ms - 7280[0m
  console.log
