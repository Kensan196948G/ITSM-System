...
```json
{
  "timestamp": "2026-02-03T21:00:38.219576",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106352908,
      "bytes_sent": 888112,
      "bytes_received_mb": 101.43,
      "bytes_sent_mb": 0.85
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.147 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.878 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.650 ms - 1516[0m
