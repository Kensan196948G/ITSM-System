...
```json
{
  "timestamp": "2026-02-23T01:26:48.466597",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 282873522,
      "bytes_sent": 2828334,
      "bytes_received_mb": 269.77,
      "bytes_sent_mb": 2.7
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.200 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.882 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.257 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.450 ms - 7275[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.818 ms - 1516[0m
