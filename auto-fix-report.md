...
```json
{
  "timestamp": "2026-02-22T21:27:26.748658",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 272148710,
      "bytes_sent": 2108578,
      "bytes_received_mb": 259.54,
      "bytes_sent_mb": 2.01
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.359 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.728 ms - 7289[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.589 ms - 1516[0m
