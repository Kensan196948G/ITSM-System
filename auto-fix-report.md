...
```json
{
  "timestamp": "2026-02-20T14:54:25.632329",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 219213464,
      "bytes_sent": 1591555,
      "bytes_received_mb": 209.06,
      "bytes_sent_mb": 1.52
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.285 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.401 ms - 7283[0m
  console.log
