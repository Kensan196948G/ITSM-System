...
```json
{
  "timestamp": "2026-02-12T10:00:19.633560",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140871051,
      "bytes_sent": 1124984,
      "bytes_received_mb": 134.35,
      "bytes_sent_mb": 1.07
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 8.713 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.730 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.512 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 8.790 ms - 1516[0m
