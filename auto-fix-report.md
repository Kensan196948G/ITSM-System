...
```json
{
  "timestamp": "2026-02-02T11:11:19.135769",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105624769,
      "bytes_sent": 676981,
      "bytes_received_mb": 100.73,
      "bytes_sent_mb": 0.65
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 23.658 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 59.630 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 13.656 ms - 1516[0m
