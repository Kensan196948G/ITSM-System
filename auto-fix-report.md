...
```json
{
  "timestamp": "2026-02-13T21:11:17.361734",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 138969052,
      "bytes_sent": 1143712,
      "bytes_received_mb": 132.53,
      "bytes_sent_mb": 1.09
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.874 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.608 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.973 ms - 7280[0m
  console.log
