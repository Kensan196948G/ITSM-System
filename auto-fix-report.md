...
```json
{
  "timestamp": "2026-02-21T17:36:22.288765",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 275504139,
      "bytes_sent": 5165231,
      "bytes_received_mb": 262.74,
      "bytes_sent_mb": 4.93
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.539 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.617 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.000 ms - 7287[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.687 ms - 1516[0m
