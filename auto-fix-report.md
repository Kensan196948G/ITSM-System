...
```json
{
  "timestamp": "2026-02-28T05:03:38.341321",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 473223451,
      "bytes_sent": 2648576,
      "bytes_received_mb": 451.3,
      "bytes_sent_mb": 2.53
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.594 s)
