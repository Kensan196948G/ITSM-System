...
```json
{
  "timestamp": "2026-02-17T16:15:10.364923",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 7.7,
      "message": "Memory usage normal: 7.7%",
      "critical": false,
      "details": {
        "total_mb": 15989,
        "used_mb": 1224,
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 276643763,
      "bytes_sent": 2867597,
      "bytes_received_mb": 263.83,
      "bytes_sent_mb": 2.73
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 7.235 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.903 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.829 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.564 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 7.972 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    GET /api/v1/export/incidents
      ✓ 認証なしで401エラー (7 ms)
      ✓ CSV形式でインシデントエクスポート（200） (18 ms)
      ✓ JSON形式でインシデントエクスポート（200） (19 ms)
      ✓ Excel形式でインシデントエクスポート（200） (67 ms)
    GET /api/v1/export/vulnerabilities
      ✓ CSV形式で脆弱性エクスポート（200） (12 ms)
      ✓ JSON形式で脆弱性エクスポート（200） (11 ms)
    GET /api/v1/export/changes
      ✓ CSV形式で変更管理エクスポート（200） (18 ms)
    GET /api/v1/export/assets
      ✓ CSV形式で資産エクスポート（200） (10 ms)
      ✓ Excel形式で資産エクスポート（200） (22 ms)
    Export with date filters
      ✓ 日付フィルタ付きでエクスポート (11 ms)
...
PASS backend/__tests__/unit/middleware/cache.test.js
  Cache Middleware
    ✓ generateCacheKey sorts query params (4 ms)
    ✓ getTTL returns configured values or default (2 ms)
    ✓ cacheMiddleware caches GET responses and serves from cache (5 ms)
    ✓ invalidateCacheMiddleware clears matching patterns after success (9 ms)
...
PASS backend/__tests__/unit/middleware/metrics.test.js
  Metrics Middleware Helpers
    ✓ updates custom metrics without errors (14 ms)
