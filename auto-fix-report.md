...
```json
{
  "timestamp": "2026-02-21T16:50:42.212377",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 256898637,
      "bytes_sent": 2856866,
      "bytes_received_mb": 245.0,
      "bytes_sent_mb": 2.72
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.082 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.863 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.427 ms - 7278[0m
  console.log
