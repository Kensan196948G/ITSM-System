...
```json
{
  "timestamp": "2026-02-21T20:51:23.192646",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 282590905,
      "bytes_sent": 3485653,
      "bytes_received_mb": 269.5,
      "bytes_sent_mb": 3.32
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.211 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.351 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.481 ms - 7278[0m
  console.log
