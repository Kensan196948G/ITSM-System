...
```json
{
  "timestamp": "2026-02-02T14:33:04.469430",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106192285,
      "bytes_sent": 869555,
      "bytes_received_mb": 101.27,
      "bytes_sent_mb": 0.83
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 14.421 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 79.458 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 53.168 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    ...
    GET /api/v1/export/vulnerabilities
      ✓ CSV形式で脆弱性エクスポート（200） (45 ms)
      ✓ JSON形式で脆弱性エクスポート（200） (21 ms)
    GET /api/v1/export/changes
      ✓ CSV形式で変更管理エクスポート（200） (22 ms)
    GET /api/v1/export/assets
      ✓ CSV形式で資産エクスポート（200） (25 ms)
      ✓ Excel形式で資産エクスポート（200） (92 ms)
    Export with date filters
      ✓ 日付フィルタ付きでエクスポート (69 ms)
