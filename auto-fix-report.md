...
```json
{
  "timestamp": "2026-02-22T10:57:50.627810",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 283737602,
      "bytes_sent": 5382968,
      "bytes_received_mb": 270.59,
      "bytes_sent_mb": 5.13
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.674 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.706 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.832 ms - 1516[0m
