...
```json
{
  "timestamp": "2026-02-13T15:45:14.573369",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139144523,
      "bytes_sent": 883870,
      "bytes_received_mb": 132.7,
      "bytes_sent_mb": 0.84
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.259 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.502 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.889 ms - 7277[0m
  console.log
