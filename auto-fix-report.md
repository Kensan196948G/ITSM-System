...
```json
{
  "timestamp": "2026-02-21T10:49:31.818537",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 256725055,
      "bytes_sent": 2478402,
      "bytes_received_mb": 244.83,
      "bytes_sent_mb": 2.36
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.443 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.398 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.139 ms - 7281[0m
  console.log
