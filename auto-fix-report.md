...
```json
{
  "timestamp": "2026-03-01T10:50:01.032539",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 473731774,
      "bytes_sent": 2465842,
      "bytes_received_mb": 451.79,
      "bytes_sent_mb": 2.35
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.423 s)
