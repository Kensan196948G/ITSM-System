...
```json
{
  "timestamp": "2026-02-28T09:13:48.343777",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 135308155,
      "bytes_sent": 1162414,
      "bytes_received_mb": 129.04,
      "bytes_sent_mb": 1.11
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.414 s)
