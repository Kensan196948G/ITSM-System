...
```json
{
  "timestamp": "2026-02-07T19:29:34.606824",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139997962,
      "bytes_sent": 886393,
      "bytes_received_mb": 133.51,
      "bytes_sent_mb": 0.85
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.159 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.582 ms - 7286[0m
  console.log
