...
```json
{
  "timestamp": "2026-03-02T05:34:52.630780",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 513026614,
      "bytes_sent": 2239021,
      "bytes_received_mb": 489.26,
      "bytes_sent_mb": 2.14
    }
  }
}
...
Tests:       32 failed, 24 skipped, 2460 passed, 2516 total
Snapshots:   0 total
Time:        204.568 s
Ran all test suites.
