...
```json
{
  "timestamp": "2026-02-04T16:28:52.438675",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105718291,
      "bytes_sent": 697740,
      "bytes_received_mb": 100.82,
      "bytes_sent_mb": 0.67
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 25.622 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 72.283 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 17.460 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    GET /api/v1/export/incidents
      ...
      ✓ Excel形式でインシデントエクスポート（200） (70 ms)
    GET /api/v1/export/vulnerabilities
      ✓ CSV形式で脆弱性エクスポート（200） (29 ms)
      ✓ JSON形式で脆弱性エクスポート（200） (36 ms)
    GET /api/v1/export/changes
      ✓ CSV形式で変更管理エクスポート（200） (36 ms)
    GET /api/v1/export/assets
      ✓ CSV形式で資産エクスポート（200） (36 ms)
      ✓ Excel形式で資産エクスポート（200） (85 ms)
