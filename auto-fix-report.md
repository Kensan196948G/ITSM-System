...
```json
{
  "timestamp": "2026-02-04T00:38:02.301221",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106132916,
      "bytes_sent": 966845,
      "bytes_received_mb": 101.22,
      "bytes_sent_mb": 0.92
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.061 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.774 ms - 1516[0m
