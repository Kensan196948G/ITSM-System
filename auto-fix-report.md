...
```json
{
  "timestamp": "2026-02-25T14:03:02.922348",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 279077553,
      "bytes_sent": 2426291,
      "bytes_received_mb": 266.15,
      "bytes_sent_mb": 2.31
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 13.543 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 8.886 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 7.443 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.909 ms - 7285[0m
  console.log
