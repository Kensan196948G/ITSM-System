...
```json
{
  "timestamp": "2026-02-19T10:46:15.076282",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 142603715,
      "bytes_sent": 964573,
      "bytes_received_mb": 136.0,
      "bytes_sent_mb": 0.92
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.523 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.233 ms - 7281[0m
  console.log
