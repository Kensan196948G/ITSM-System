...
```json
{
  "timestamp": "2026-02-03T17:04:44.731641",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105948060,
      "bytes_sent": 847622,
      "bytes_received_mb": 101.04,
      "bytes_sent_mb": 0.81
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 13.815 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 78.040 ms - 7282[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 49.576 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    GET /api/v1/export/incidents
      ...
      ✓ Excel形式でインシデントエクスポート（200） (66 ms)
    GET /api/v1/export/vulnerabilities
      ✓ CSV形式で脆弱性エクスポート（200） (32 ms)
      ✓ JSON形式で脆弱性エクスポート（200） (38 ms)
    GET /api/v1/export/changes
      ✓ CSV形式で変更管理エクスポート（200） (37 ms)
    GET /api/v1/export/assets
      ✓ CSV形式で資産エクスポート（200） (22 ms)
      ✓ Excel形式で資産エクスポート（200） (87 ms)
    Export with date filters
      ✓ 日付フィルタ付きでエクスポート (57 ms)
