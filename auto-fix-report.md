...
```json
{
  "timestamp": "2026-02-09T22:50:21.204317",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140410248,
      "bytes_sent": 928859,
      "bytes_received_mb": 133.91,
      "bytes_sent_mb": 0.89
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.852 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.823 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.181 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.987 ms - 1516[0m
