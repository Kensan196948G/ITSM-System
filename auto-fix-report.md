...
```json
{
  "timestamp": "2026-03-01T21:40:28.580214",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 473717073,
      "bytes_sent": 2559460,
      "bytes_received_mb": 451.77,
      "bytes_sent_mb": 2.44
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.794 s)
