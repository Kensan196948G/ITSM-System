...
```json
{
  "timestamp": "2026-02-20T13:20:49.550109",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 272327354,
      "bytes_sent": 1963006,
      "bytes_received_mb": 259.71,
      "bytes_sent_mb": 1.87
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.338 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.851 ms - 7283[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.307 ms - 1516[0m
