...
```json
{
  "timestamp": "2026-02-27T12:23:31.854673",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 279277477,
      "bytes_sent": 2444336,
      "bytes_received_mb": 266.34,
      "bytes_sent_mb": 2.33
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.948 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.482 ms - 7277[0m
  console.log
