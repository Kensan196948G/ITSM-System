...
```json
{
  "timestamp": "2026-02-27T23:12:48.143337",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 730459347,
      "bytes_sent": 4040037,
      "bytes_received_mb": 696.62,
      "bytes_sent_mb": 3.85
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.078 s)
