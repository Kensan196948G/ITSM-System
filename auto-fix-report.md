...
```json
{
  "timestamp": "2026-02-27T22:58:38.517220",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 730630293,
      "bytes_sent": 4916945,
      "bytes_received_mb": 696.78,
      "bytes_sent_mb": 4.69
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.257 s)
