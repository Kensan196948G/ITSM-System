...
```json
{
  "timestamp": "2026-02-25T23:48:51.370101",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 264968152,
      "bytes_sent": 4191418,
      "bytes_received_mb": 252.69,
      "bytes_sent_mb": 4.0
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.627 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.156 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.210 ms - 1516[0m
