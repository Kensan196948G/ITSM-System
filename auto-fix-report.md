...
```json
{
  "timestamp": "2026-02-21T16:33:26.503047",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 258600195,
      "bytes_sent": 3038989,
      "bytes_received_mb": 246.62,
      "bytes_sent_mb": 2.9
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 8.905 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 8.949 ms - 1516[0m
