...
```json
{
  "timestamp": "2026-02-28T17:37:54.303844",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 721012781,
      "bytes_sent": 4871292,
      "bytes_received_mb": 687.61,
      "bytes_sent_mb": 4.65
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.823 s)
