...
```json
{
  "timestamp": "2026-02-27T16:52:14.299143",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 266411153,
      "bytes_sent": 2545779,
      "bytes_received_mb": 254.07,
      "bytes_sent_mb": 2.43
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (8.953 s)
