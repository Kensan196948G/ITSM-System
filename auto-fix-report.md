...
```json
{
  "timestamp": "2026-02-03T22:14:55.503010",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 210040281,
      "bytes_sent": 1672210,
      "bytes_received_mb": 200.31,
      "bytes_sent_mb": 1.59
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 14.906 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 70.749 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 42.797 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    GET /api/v1/export/incidents
      ...
      ✓ Excel形式でインシデントエクスポート（200） (85 ms)
