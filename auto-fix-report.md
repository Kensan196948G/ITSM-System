...
```json
{
  "timestamp": "2026-02-02T17:48:56.228238",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106168366,
      "bytes_sent": 647603,
      "bytes_received_mb": 101.25,
      "bytes_sent_mb": 0.62
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.110 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 8.362 ms - 1516[0m
