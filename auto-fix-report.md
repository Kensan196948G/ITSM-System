...
```json
{
  "timestamp": "2026-02-13T06:38:53.100290",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 138791414,
      "bytes_sent": 883648,
      "bytes_received_mb": 132.36,
      "bytes_sent_mb": 0.84
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.471 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.977 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.388 ms - 7280[0m
  console.log
