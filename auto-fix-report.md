...
```json
{
  "timestamp": "2026-03-01T00:00:23.154103",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 731558949,
      "bytes_sent": 5156647,
      "bytes_received_mb": 697.67,
      "bytes_sent_mb": 4.92
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.084 s)
