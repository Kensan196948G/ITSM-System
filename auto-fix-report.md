...
```json
{
  "timestamp": "2026-02-20T21:59:51.310435",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 284108774,
      "bytes_sent": 4427488,
      "bytes_received_mb": 270.95,
      "bytes_sent_mb": 4.22
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.019 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.837 ms - 7284[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.064 ms - 1516[0m
