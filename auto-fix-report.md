...
```json
{
  "timestamp": "2026-02-04T10:59:33.056504",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106298048,
      "bytes_sent": 703339,
      "bytes_received_mb": 101.37,
      "bytes_sent_mb": 0.67
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 29.862 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 49.197 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 9.061 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    ...
    GET /api/v1/export/vulnerabilities
      ✓ CSV形式で脆弱性エクスポート（200） (22 ms)
      ✓ JSON形式で脆弱性エクスポート（200） (19 ms)
    GET /api/v1/export/changes
      ✓ CSV形式で変更管理エクスポート（200） (50 ms)
    GET /api/v1/export/assets
      ✓ CSV形式で資産エクスポート（200） (43 ms)
      ✓ Excel形式で資産エクスポート（200） (81 ms)
