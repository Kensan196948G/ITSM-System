...
```json
{
  "timestamp": "2026-02-10T22:43:52.028542",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.620 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.784 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.565 ms - 7281[0m
  console.log
