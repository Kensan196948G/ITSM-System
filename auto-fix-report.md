...
```json
{
  "timestamp": "2026-02-21T06:19:09.580582",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 261671198,
      "bytes_sent": 1965772,
      "bytes_received_mb": 249.55,
      "bytes_sent_mb": 1.87
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.524 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.515 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.797 ms - 7275[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.306 ms - 1516[0m
