...
```json
{
  "timestamp": "2026-02-28T23:25:52.191871",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 727672532,
      "bytes_sent": 5137280,
      "bytes_received_mb": 693.96,
      "bytes_sent_mb": 4.9
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.688 s)
