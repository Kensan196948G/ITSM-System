...
```json
{
  "timestamp": "2026-02-27T10:08:37.281160",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 8.6,
      "message": "Memory usage normal: 8.6%",
      "critical": false,
      "details": {
        "total_mb": 15990,
        "used_mb": 1368,
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 275382859,
      "bytes_sent": 2150446,
      "bytes_received_mb": 262.63,
      "bytes_sent_mb": 2.05
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.529 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.010 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.555 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 20.441 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 7.538 ms - 1516[0m
