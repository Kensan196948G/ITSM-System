...
```json
{
  "timestamp": "2026-03-01T12:03:09.888188",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 731446269,
      "bytes_sent": 6052910,
      "bytes_received_mb": 697.56,
      "bytes_sent_mb": 5.77
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.849 s)
