...
```json
{
  "timestamp": "2026-02-27T22:46:44.682248",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 267143175,
      "bytes_sent": 2284687,
      "bytes_received_mb": 254.77,
      "bytes_sent_mb": 2.18
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.134 s)
