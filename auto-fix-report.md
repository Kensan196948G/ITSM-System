...
```json
{
  "timestamp": "2026-02-28T07:15:32.105428",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 729348391,
      "bytes_sent": 4360192,
      "bytes_received_mb": 695.56,
      "bytes_sent_mb": 4.16
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.226 s)
