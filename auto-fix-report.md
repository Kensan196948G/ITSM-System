...
```json
{
  "timestamp": "2026-02-20T04:56:23.673044",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 283990168,
      "bytes_sent": 4581828,
      "bytes_received_mb": 270.83,
      "bytes_sent_mb": 4.37
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 7.749 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 8.175 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.404 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.342 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 7.061 ms - 1516[0m
