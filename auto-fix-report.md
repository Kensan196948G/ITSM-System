...
```json
{
  "timestamp": "2026-02-03T19:22:49.147828",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 107110923,
      "bytes_sent": 655895,
      "bytes_received_mb": 102.15,
      "bytes_sent_mb": 0.63
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.079 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.848 ms - 1516[0m
