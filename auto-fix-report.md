...
```json
{
  "timestamp": "2026-02-05T02:24:56.161581",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 108251834,
      "bytes_sent": 978796,
      "bytes_received_mb": 103.24,
      "bytes_sent_mb": 0.93
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.168 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.473 ms - 7276[0m
  console.log
