...
```json
{
  "timestamp": "2026-02-26T14:34:23.893724",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 276420243,
      "bytes_sent": 3049659,
      "bytes_received_mb": 263.61,
      "bytes_sent_mb": 2.91
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.755 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.041 ms - 7277[0m
  console.log
