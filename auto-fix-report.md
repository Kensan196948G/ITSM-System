...
```json
{
  "timestamp": "2026-03-01T15:11:09.661257",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 721493008,
      "bytes_sent": 4219277,
      "bytes_received_mb": 688.07,
      "bytes_sent_mb": 4.02
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.315 s)
