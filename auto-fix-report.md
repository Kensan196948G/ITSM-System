...
```json
{
  "timestamp": "2026-02-10T05:22:14.122254",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 277532683,
      "bytes_sent": 1839687,
      "bytes_received_mb": 264.68,
      "bytes_sent_mb": 1.75
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.700 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 8.630 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.188 ms - 7281[0m
  console.log
