...
```json
{
  "timestamp": "2026-02-25T01:35:04.064067",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 253887928,
      "bytes_sent": 2508950,
      "bytes_received_mb": 242.13,
      "bytes_sent_mb": 2.39
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.997 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.452 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.596 ms - 7274[0m
  console.log
