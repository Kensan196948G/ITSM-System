...
```json
{
  "timestamp": "2026-02-02T08:24:04.837786",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106112638,
      "bytes_sent": 1194127,
      "bytes_received_mb": 101.2,
      "bytes_sent_mb": 1.14
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 11.835 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 32.026 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 11.965 ms - 1516[0m
