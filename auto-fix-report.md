...
```json
{
  "timestamp": "2026-02-05T21:23:07.456695",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139611340,
      "bytes_sent": 958969,
      "bytes_received_mb": 133.14,
      "bytes_sent_mb": 0.91
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.140 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 20.082 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.750 ms - 1516[0m
