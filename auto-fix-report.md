...
```json
{
  "timestamp": "2026-02-20T00:48:46.435037",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 282642089,
      "bytes_sent": 2880242,
      "bytes_received_mb": 269.55,
      "bytes_sent_mb": 2.75
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.284 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.065 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.861 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.965 ms - 1516[0m
