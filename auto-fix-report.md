...
```json
{
  "timestamp": "2026-02-04T20:16:23.872544",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106737108,
      "bytes_sent": 2191467,
      "bytes_received_mb": 101.79,
      "bytes_sent_mb": 2.09
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 7.226 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.476 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 7.142 ms - 1516[0m
