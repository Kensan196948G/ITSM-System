...
```json
{
  "timestamp": "2026-02-11T13:40:05.465276",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 5.3,
      "message": "Memory usage normal: 5.3%",
      "critical": false,
      "details": {
        "total_mb": 15994,
        "used_mb": 846,
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140717065,
      "bytes_sent": 1170710,
      "bytes_received_mb": 134.2,
      "bytes_sent_mb": 1.12
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.557 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.764 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.532 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.158 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.799 ms - 1516[0m
