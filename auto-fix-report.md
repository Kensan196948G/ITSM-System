...
```json
{
  "timestamp": "2026-02-03T05:18:03.053126",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105673726,
      "bytes_sent": 679426,
      "bytes_received_mb": 100.78,
      "bytes_sent_mb": 0.65
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 12.926 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 53.368 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 14.853 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    ...
    GET /api/v1/export/assets
      ...
      ✓ Excel形式で資産エクスポート（200） (68 ms)
    Export with date filters
      ✓ 日付フィルタ付きでエクスポート (26 ms)
