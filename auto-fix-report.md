...
```json
{
  "timestamp": "2026-02-28T22:15:10.037280",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 731298023,
      "bytes_sent": 4536107,
      "bytes_received_mb": 697.42,
      "bytes_sent_mb": 4.33
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.512 s)
