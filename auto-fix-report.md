...
```json
{
  "timestamp": "2026-02-02T23:39:46.413432",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 209214361,
      "bytes_sent": 4014035,
      "bytes_received_mb": 199.52,
      "bytes_sent_mb": 3.83
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.421 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.746 ms - 7281[0m
  console.log
