...
```json
{
  "timestamp": "2026-02-02T15:22:24.916976",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 6.8,
      "message": "Memory usage normal: 6.8%",
      "critical": false,
      "details": {
        "total_mb": 15990,
        "used_mb": 1083,
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105758184,
      "bytes_sent": 864343,
      "bytes_received_mb": 100.86,
      "bytes_sent_mb": 0.82
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 13.231 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 45.265 ms - 7275[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 11.918 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    GET /api/v1/export/incidents
      ...
      ✓ Excel形式でインシデントエクスポート（200） (65 ms)
    GET /api/v1/export/vulnerabilities
      ✓ CSV形式で脆弱性エクスポート（200） (39 ms)
      ✓ JSON形式で脆弱性エクスポート（200） (25 ms)
    GET /api/v1/export/changes
      ✓ CSV形式で変更管理エクスポート（200） (22 ms)
    GET /api/v1/export/assets
      ✓ CSV形式で資産エクスポート（200） (23 ms)
      ✓ Excel形式で資産エクスポート（200） (53 ms)
    Export with date filters
      ✓ 日付フィルタ付きでエクスポート (20 ms)
...
PASS backend/__tests__/unit/middleware/cache.test.js
  Cache Middleware
    ...
    ✓ cacheMiddleware caches GET responses and serves from cache (4 ms)
    ✓ invalidateCacheMiddleware clears matching patterns after success (3 ms)
