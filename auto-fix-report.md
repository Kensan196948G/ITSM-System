...
```json
{
  "timestamp": "2026-02-18T20:00:02.212066",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.275 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.277 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.262 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.233 ms - 7280[0m
  console.log
