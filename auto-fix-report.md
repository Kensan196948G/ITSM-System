...
```json
{
  "timestamp": "2026-02-20T17:01:31.572980",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 258875723,
      "bytes_sent": 3753802,
      "bytes_received_mb": 246.88,
      "bytes_sent_mb": 3.58
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.740 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.889 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.905 ms - 1516[0m
