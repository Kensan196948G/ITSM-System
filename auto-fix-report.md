...
```json
{
  "timestamp": "2026-02-20T19:29:28.429611",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 6.2,
      "message": "Memory usage normal: 6.2%",
      "critical": false,
      "details": {
        "total_mb": 15994,
        "used_mb": 992,
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.541 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.556 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.194 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.336 ms - 7282[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.760 ms - 1516[0m
...
PASS backend/__tests__/unit/middleware/metrics.test.js
  Metrics Middleware Helpers
    ✓ updates custom metrics without errors (12 ms)
