...
```json
{
  "timestamp": "2026-02-02T18:25:28.567919",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105804861,
      "bytes_sent": 669916,
      "bytes_received_mb": 100.9,
      "bytes_sent_mb": 0.64
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 10.995 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 51.122 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 12.098 ms - 1516[0m
