...
```json
{
  "timestamp": "2026-02-13T16:51:38.939685",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139283547,
      "bytes_sent": 1526090,
      "bytes_received_mb": 132.83,
      "bytes_sent_mb": 1.46
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.070 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.497 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.345 ms - 1516[0m
