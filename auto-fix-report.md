...
```json
{
  "timestamp": "2026-02-04T13:19:57.430538",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106571114,
      "bytes_sent": 1147320,
      "bytes_received_mb": 101.63,
      "bytes_sent_mb": 1.09
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 19.927 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 34.672 ms - 7272[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 13.035 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    ...
    GET /api/v1/export/assets
      ✓ CSV形式で資産エクスポート（200） (33 ms)
      ✓ Excel形式で資産エクスポート（200） (43 ms)
