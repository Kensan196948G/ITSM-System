...
```json
{
  "timestamp": "2026-02-07T11:36:10.755278",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140089594,
      "bytes_sent": 808362,
      "bytes_received_mb": 133.6,
      "bytes_sent_mb": 0.77
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 7.065 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 8.262 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.498 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.240 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.855 ms - 1516[0m
...
PASS backend/__tests__/unit/middleware/metrics.test.js
  Metrics Middleware Helpers
    ...
    ✓ metricsEndpoint returns Prometheus payload (11 ms)
