...
```json
{
  "timestamp": "2026-02-18T05:04:07.993716",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 275380017,
      "bytes_sent": 2366278,
      "bytes_received_mb": 262.62,
      "bytes_sent_mb": 2.26
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.140 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.110 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.751 ms - 7277[0m
  console.log
