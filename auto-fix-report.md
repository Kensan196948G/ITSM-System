...
```json
{
  "timestamp": "2026-03-01T16:54:26.882950",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 729625811,
      "bytes_sent": 5131323,
      "bytes_received_mb": 695.83,
      "bytes_sent_mb": 4.89
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.809 s)
