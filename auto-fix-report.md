...
```json
{
  "timestamp": "2026-02-23T13:59:57.651674",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 150211191,
      "bytes_sent": 1319863,
      "bytes_received_mb": 143.25,
      "bytes_sent_mb": 1.26
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.188 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.906 ms - 7282[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.728 ms - 1516[0m
