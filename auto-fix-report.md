...
```json
{
  "timestamp": "2026-02-28T11:54:19.606381",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 473781127,
      "bytes_sent": 2811413,
      "bytes_received_mb": 451.83,
      "bytes_sent_mb": 2.68
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.825 s)
