...
```json
{
  "timestamp": "2026-02-23T20:23:06.826102",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 144264437,
      "bytes_sent": 1500661,
      "bytes_received_mb": 137.58,
      "bytes_sent_mb": 1.43
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.248 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.195 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 20.193 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 7.088 ms - 1516[0m
