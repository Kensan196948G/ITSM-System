...
```json
{
  "timestamp": "2026-02-19T14:31:09.862662",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 142391692,
      "bytes_sent": 1211834,
      "bytes_received_mb": 135.8,
      "bytes_sent_mb": 1.16
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.615 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.833 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.704 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 7.122 ms - 1516[0m
