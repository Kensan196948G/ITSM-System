...
```json
{
  "timestamp": "2026-02-11T10:03:40.550164",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 5.7,
      "message": "Memory usage normal: 5.7%",
      "critical": false,
      "details": {
        "total_mb": 15994,
        "used_mb": 904,
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140906084,
      "bytes_sent": 1062920,
      "bytes_received_mb": 134.38,
      "bytes_sent_mb": 1.01
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.974 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.827 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.803 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.922 ms - 7275[0m
  console.log
