...
```json
{
  "timestamp": "2026-02-27T01:05:14.173648",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140991625,
      "bytes_sent": 1140026,
      "bytes_received_mb": 134.46,
      "bytes_sent_mb": 1.09
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.559 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.683 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.647 ms - 7277[0m
  console.log
