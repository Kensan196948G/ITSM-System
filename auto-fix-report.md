...
```json
{
  "timestamp": "2026-02-04T01:10:42.764747",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 107303384,
      "bytes_sent": 2031398,
      "bytes_received_mb": 102.33,
      "bytes_sent_mb": 1.94
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.871 ms - 7273[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.062 ms - 1516[0m
