...
```json
{
  "timestamp": "2026-02-11T17:34:37.343042",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140335931,
      "bytes_sent": 802594,
      "bytes_received_mb": 133.83,
      "bytes_sent_mb": 0.77
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 10.374 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.690 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.713 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.213 ms - 7286[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 7.388 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    GET /api/v1/export/incidents
      ✓ 認証なしで401エラー (7 ms)
      ✓ CSV形式でインシデントエクスポート（200） (23 ms)
