...
```json
{
  "timestamp": "2026-02-22T15:55:59.444870",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 254180458,
      "bytes_sent": 5973754,
      "bytes_received_mb": 242.41,
      "bytes_sent_mb": 5.7
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.048 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.895 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.473 ms - 1516[0m
