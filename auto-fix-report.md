...
```json
{
  "timestamp": "2026-02-24T17:29:16.406112",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 285034938,
      "bytes_sent": 7612665,
      "bytes_received_mb": 271.83,
      "bytes_sent_mb": 7.26
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.296 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.672 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.399 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.323 ms - 1516[0m
