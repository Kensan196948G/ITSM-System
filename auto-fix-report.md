...
```json
{
  "timestamp": "2026-03-01T03:43:16.985059",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 489179254,
      "bytes_sent": 2485325,
      "bytes_received_mb": 466.52,
      "bytes_sent_mb": 2.37
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.585 s)
