...
```json
{
  "timestamp": "2026-02-24T22:16:33.998712",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 279494513,
      "bytes_sent": 2680917,
      "bytes_received_mb": 266.55,
      "bytes_sent_mb": 2.56
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.432 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 7.989 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.357 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.582 ms - 1516[0m
