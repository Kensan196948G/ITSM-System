...
```json
{
  "timestamp": "2026-02-06T00:46:57.504027",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 272780269,
      "bytes_sent": 1590072,
      "bytes_received_mb": 260.14,
      "bytes_sent_mb": 1.52
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 11.270 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 52.143 ms - 7274[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 11.706 ms - 1516[0m
