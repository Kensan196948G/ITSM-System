...
```json
{
  "timestamp": "2026-03-01T15:27:45.377393",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 721233397,
      "bytes_sent": 7116034,
      "bytes_received_mb": 687.82,
      "bytes_sent_mb": 6.79
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.409 s)
