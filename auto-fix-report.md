...
```json
{
  "timestamp": "2026-02-21T21:01:43.113448",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 143895753,
      "bytes_sent": 1098310,
      "bytes_received_mb": 137.23,
      "bytes_sent_mb": 1.05
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.920 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.077 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.678 ms - 1516[0m
