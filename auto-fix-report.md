...
```json
{
  "timestamp": "2026-03-01T07:57:37.126896",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 714584132,
      "bytes_sent": 5000442,
      "bytes_received_mb": 681.48,
      "bytes_sent_mb": 4.77
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.531 s)
