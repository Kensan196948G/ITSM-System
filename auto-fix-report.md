...
```json
{
  "timestamp": "2026-02-03T15:00:54.412800",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106239754,
      "bytes_sent": 855204,
      "bytes_received_mb": 101.32,
      "bytes_sent_mb": 0.82
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.498 ms - 7278[0m
  console.log
