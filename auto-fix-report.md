...
```json
{
  "timestamp": "2026-02-06T14:55:28.155379",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139299028,
      "bytes_sent": 737120,
      "bytes_received_mb": 132.85,
      "bytes_sent_mb": 0.7
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 12.849 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 35.980 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 11.592 ms - 1516[0m
