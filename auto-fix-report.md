...
```json
{
  "timestamp": "2026-02-14T05:38:29.392382",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 138849846,
      "bytes_sent": 808338,
      "bytes_received_mb": 132.42,
      "bytes_sent_mb": 0.77
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.936 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.091 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.238 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.545 ms - 1516[0m
