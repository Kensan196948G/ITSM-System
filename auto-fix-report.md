...
```json
{
  "timestamp": "2026-02-03T14:14:30.613182",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105985554,
      "bytes_sent": 754195,
      "bytes_received_mb": 101.08,
      "bytes_sent_mb": 0.72
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 11.667 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 51.993 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 11.227 ms - 1516[0m
