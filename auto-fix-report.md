...
```json
{
  "timestamp": "2026-02-28T13:40:08.848443",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 721195905,
      "bytes_sent": 4973676,
      "bytes_received_mb": 687.79,
      "bytes_sent_mb": 4.74
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.61 s)
