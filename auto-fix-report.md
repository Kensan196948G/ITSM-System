...
```json
{
  "timestamp": "2026-02-28T07:57:26.761003",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 134994426,
      "bytes_sent": 1274546,
      "bytes_received_mb": 128.74,
      "bytes_sent_mb": 1.22
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.335 s)
