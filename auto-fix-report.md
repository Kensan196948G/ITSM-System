...
```json
{
  "timestamp": "2026-03-01T00:55:55.571103",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 369596163,
      "bytes_sent": 1355373,
      "bytes_received_mb": 352.47,
      "bytes_sent_mb": 1.29
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.76 s)
