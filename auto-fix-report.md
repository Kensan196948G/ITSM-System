...
```json
{
  "timestamp": "2026-02-25T20:12:29.842713",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 250932597,
      "bytes_sent": 2475614,
      "bytes_received_mb": 239.31,
      "bytes_sent_mb": 2.36
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.475 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.393 ms - 7276[0m
  console.log
