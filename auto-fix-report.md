...
```json
{
  "timestamp": "2026-02-03T09:25:13.409348",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106025524,
      "bytes_sent": 682482,
      "bytes_received_mb": 101.11,
      "bytes_sent_mb": 0.65
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 19.014 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 45.093 ms - 7273[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 23.165 ms - 1516[0m
