...
```json
{
  "timestamp": "2026-02-27T23:29:44.813111",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 241942890,
      "bytes_sent": 4900465,
      "bytes_received_mb": 230.73,
      "bytes_sent_mb": 4.67
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.321 s)
