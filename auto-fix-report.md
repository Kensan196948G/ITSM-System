...
```json
{
  "timestamp": "2026-02-04T16:54:36.556593",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106926306,
      "bytes_sent": 691850,
      "bytes_received_mb": 101.97,
      "bytes_sent_mb": 0.66
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 12.567 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 53.699 ms - 7281[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 23.508 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    ...
    GET /api/v1/export/assets
      ...
      ✓ Excel形式で資産エクスポート（200） (65 ms)
    Export with date filters
      ✓ 日付フィルタ付きでエクスポート (40 ms)
