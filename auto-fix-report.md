...
```json
{
  "timestamp": "2026-02-03T10:51:10.112869",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106404156,
      "bytes_sent": 635623,
      "bytes_received_mb": 101.47,
      "bytes_sent_mb": 0.61
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 11.455 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 49.787 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 13.765 ms - 1516[0m
