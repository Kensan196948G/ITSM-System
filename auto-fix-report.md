...
```json
{
  "timestamp": "2026-02-26T21:18:31.657765",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 266821869,
      "bytes_sent": 2262540,
      "bytes_received_mb": 254.46,
      "bytes_sent_mb": 2.16
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.722 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.890 ms - 7280[0m
  console.log
