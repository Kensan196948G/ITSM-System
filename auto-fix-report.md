...
```json
{
  "timestamp": "2026-03-01T14:47:12.305607",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 727836002,
      "bytes_sent": 4636377,
      "bytes_received_mb": 694.12,
      "bytes_sent_mb": 4.42
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.156 s)
