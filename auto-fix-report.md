...
```json
{
  "timestamp": "2026-02-21T21:15:22.334679",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 256616232,
      "bytes_sent": 2264074,
      "bytes_received_mb": 244.73,
      "bytes_sent_mb": 2.16
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.621 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.963 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 8.818 ms - 1516[0m
