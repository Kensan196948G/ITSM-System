...
```json
{
  "timestamp": "2026-03-01T23:29:51.027786",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 369901790,
      "bytes_sent": 1350158,
      "bytes_received_mb": 352.77,
      "bytes_sent_mb": 1.29
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.967 s)
