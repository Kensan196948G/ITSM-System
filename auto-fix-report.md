...
```json
{
  "timestamp": "2026-02-22T21:54:37.403870",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 272592151,
      "bytes_sent": 2753277,
      "bytes_received_mb": 259.96,
      "bytes_sent_mb": 2.63
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.299 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.106 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.001 ms - 1516[0m
