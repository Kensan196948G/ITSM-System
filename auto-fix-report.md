...
```json
{
  "timestamp": "2026-02-17T13:02:38.325102",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 280803159,
      "bytes_sent": 2322963,
      "bytes_received_mb": 267.79,
      "bytes_sent_mb": 2.22
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.835 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.916 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.810 ms - 7278[0m
  console.log
