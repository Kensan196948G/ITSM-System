...
```json
{
  "timestamp": "2026-02-26T17:11:09.631653",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 276338541,
      "bytes_sent": 2237611,
      "bytes_received_mb": 263.54,
      "bytes_sent_mb": 2.13
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 9.727 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 8.202 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 7.505 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 20.331 ms - 7281[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 7.643 ms - 1516[0m
