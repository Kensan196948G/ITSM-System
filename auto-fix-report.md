...
```json
{
  "timestamp": "2026-03-01T23:54:29.298970",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 726844684,
      "bytes_sent": 5073626,
      "bytes_received_mb": 693.17,
      "bytes_sent_mb": 4.84
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.311 s)
