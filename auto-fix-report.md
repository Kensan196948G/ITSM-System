...
```json
{
  "timestamp": "2026-02-04T13:49:52.522277",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105877213,
      "bytes_sent": 841295,
      "bytes_received_mb": 100.97,
      "bytes_sent_mb": 0.8
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 12.090 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 41.224 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 12.176 ms - 1516[0m
