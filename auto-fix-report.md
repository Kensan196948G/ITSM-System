...
```json
{
  "timestamp": "2026-02-21T09:16:48.610325",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 278078102,
      "bytes_sent": 2266824,
      "bytes_received_mb": 265.2,
      "bytes_sent_mb": 2.16
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.125 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.671 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.778 ms - 1516[0m
