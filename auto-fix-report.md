...
```json
{
  "timestamp": "2026-02-20T14:30:24.214899",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 272861309,
      "bytes_sent": 1925775,
      "bytes_received_mb": 260.22,
      "bytes_sent_mb": 1.84
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.401 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.425 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.616 ms - 7278[0m
  console.log
