...
```json
{
  "timestamp": "2026-02-23T22:19:51.641460",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 257663096,
      "bytes_sent": 2043578,
      "bytes_received_mb": 245.73,
      "bytes_sent_mb": 1.95
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.950 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.903 ms - 7281[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.484 ms - 1516[0m
