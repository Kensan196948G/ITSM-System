...
```json
{
  "timestamp": "2026-02-02T04:35:29.113795",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 107265807,
      "bytes_sent": 623229,
      "bytes_received_mb": 102.3,
      "bytes_sent_mb": 0.59
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.028 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.653 ms - 1516[0m
