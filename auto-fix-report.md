...
```json
{
  "timestamp": "2026-02-28T18:32:45.012951",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 472075100,
      "bytes_sent": 5392261,
      "bytes_received_mb": 450.21,
      "bytes_sent_mb": 5.14
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.31 s)
