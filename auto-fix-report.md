...
```json
{
  "timestamp": "2026-02-03T18:28:33.285239",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106330800,
      "bytes_sent": 874457,
      "bytes_received_mb": 101.4,
      "bytes_sent_mb": 0.83
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.205 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.603 ms - 1516[0m
