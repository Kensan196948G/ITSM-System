...
```json
{
  "timestamp": "2026-02-27T15:13:03.957714",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 246675182,
      "bytes_sent": 3575999,
      "bytes_received_mb": 235.25,
      "bytes_sent_mb": 3.41
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.480 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.934 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.268 ms - 7278[0m
  console.log
