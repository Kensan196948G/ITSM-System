...
```json
{
  "timestamp": "2026-02-21T10:15:59.451282",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 256986555,
      "bytes_sent": 2199477,
      "bytes_received_mb": 245.08,
      "bytes_sent_mb": 2.1
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.579 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.456 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.082 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.759 ms - 1516[0m
