...
```json
{
  "timestamp": "2026-02-27T20:48:34.730373",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 730289009,
      "bytes_sent": 4967202,
      "bytes_received_mb": 696.46,
      "bytes_sent_mb": 4.74
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.907 s)
