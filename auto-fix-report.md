...
```json
{
  "timestamp": "2026-02-02T16:40:08.822528",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105655841,
      "bytes_sent": 694291,
      "bytes_received_mb": 100.76,
      "bytes_sent_mb": 0.66
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.345 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.514 ms - 1516[0m
