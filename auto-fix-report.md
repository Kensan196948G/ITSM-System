...
```json
{
  "timestamp": "2026-02-27T21:01:30.223848",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 473182963,
      "bytes_sent": 2461639,
      "bytes_received_mb": 451.26,
      "bytes_sent_mb": 2.35
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.544 s)
