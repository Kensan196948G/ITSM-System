...
```json
{
  "timestamp": "2026-02-21T17:18:56.262786",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 146693484,
      "bytes_sent": 1244405,
      "bytes_received_mb": 139.9,
      "bytes_sent_mb": 1.19
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.191 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.570 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.761 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.647 ms - 1516[0m
