...
```json
{
  "timestamp": "2026-02-07T14:55:13.877143",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 141085362,
      "bytes_sent": 777426,
      "bytes_received_mb": 134.55,
      "bytes_sent_mb": 0.74
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.022 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.812 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.467 ms - 7282[0m
  console.log
