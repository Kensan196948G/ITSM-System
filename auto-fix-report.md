...
```json
{
  "timestamp": "2026-02-24T05:34:45.803211",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 278189246,
      "bytes_sent": 4503964,
      "bytes_received_mb": 265.3,
      "bytes_sent_mb": 4.3
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.639 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.816 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.778 ms - 7280[0m
  console.log
