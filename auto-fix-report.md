...
```json
{
  "timestamp": "2026-02-23T06:44:15.574547",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 147039892,
      "bytes_sent": 1186905,
      "bytes_received_mb": 140.23,
      "bytes_sent_mb": 1.13
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.573 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.572 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.888 ms - 7277[0m
  console.log
