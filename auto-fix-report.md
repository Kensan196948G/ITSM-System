...
```json
{
  "timestamp": "2026-02-26T10:24:41.593233",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 250631206,
      "bytes_sent": 2400576,
      "bytes_received_mb": 239.02,
      "bytes_sent_mb": 2.29
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.926 ms - 7281[0m
  console.log
