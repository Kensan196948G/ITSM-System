...
```json
{
  "timestamp": "2026-02-24T08:47:45.659332",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 285363223,
      "bytes_sent": 2339046,
      "bytes_received_mb": 272.14,
      "bytes_sent_mb": 2.23
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.414 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.737 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.058 ms - 7281[0m
  console.log
