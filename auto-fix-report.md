...
```json
{
  "timestamp": "2026-02-26T22:27:34.943259",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 250599025,
      "bytes_sent": 2759280,
      "bytes_received_mb": 238.99,
      "bytes_sent_mb": 2.63
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.748 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.155 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.903 ms - 1516[0m
