...
```json
{
  "timestamp": "2026-02-15T17:02:19.576807",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 8.0,
      "message": "Memory usage normal: 8.0%",
      "critical": false,
      "details": {
        "total_mb": 15993,
        "used_mb": 1281,
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 273303189,
      "bytes_sent": 2209291,
      "bytes_received_mb": 260.64,
      "bytes_sent_mb": 2.11
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 7.517 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.845 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.261 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.817 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.715 ms - 1516[0m
