...
```json
{
  "timestamp": "2026-02-13T09:07:15.520501",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139035781,
      "bytes_sent": 1208545,
      "bytes_received_mb": 132.59,
      "bytes_sent_mb": 1.15
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.812 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.643 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.364 ms - 7275[0m
  console.log
