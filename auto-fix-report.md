...
```json
{
  "timestamp": "2026-03-01T02:42:00.340344",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 369894962,
      "bytes_sent": 1567325,
      "bytes_received_mb": 352.76,
      "bytes_sent_mb": 1.49
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (8.975 s)
