...
```json
{
  "timestamp": "2026-03-01T10:35:24.768910",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 369223959,
      "bytes_sent": 1354675,
      "bytes_received_mb": 352.12,
      "bytes_sent_mb": 1.29
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.601 s)
