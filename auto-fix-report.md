...
```json
{
  "timestamp": "2026-03-01T06:02:43.877491",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 369332232,
      "bytes_sent": 1403614,
      "bytes_received_mb": 352.22,
      "bytes_sent_mb": 1.34
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.557 s)
