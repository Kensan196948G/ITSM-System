...
```json
{
  "timestamp": "2026-02-03T18:55:02.164167",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106008919,
      "bytes_sent": 872016,
      "bytes_received_mb": 101.1,
      "bytes_sent_mb": 0.83
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 13.917 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 62.337 ms - 7273[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 13.044 ms - 1516[0m
