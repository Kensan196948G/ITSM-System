...
```json
{
  "timestamp": "2026-02-28T09:31:33.313376",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 727080201,
      "bytes_sent": 4281683,
      "bytes_received_mb": 693.4,
      "bytes_sent_mb": 4.08
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.504 s)
