...
```json
{
  "timestamp": "2026-02-15T20:44:46.333092",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139376909,
      "bytes_sent": 871963,
      "bytes_received_mb": 132.92,
      "bytes_sent_mb": 0.83
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.825 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.521 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.120 ms - 7277[0m
  console.log
