...
```json
{
  "timestamp": "2026-03-01T20:57:08.908589",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 725738568,
      "bytes_sent": 6767708,
      "bytes_received_mb": 692.12,
      "bytes_sent_mb": 6.45
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.908 s)
