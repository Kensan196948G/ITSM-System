...
```json
{
  "timestamp": "2026-02-08T15:16:49.988189",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140646002,
      "bytes_sent": 1233133,
      "bytes_received_mb": 134.13,
      "bytes_sent_mb": 1.18
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.662 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.704 ms - 7277[0m
  console.log
