...
```json
{
  "timestamp": "2026-02-20T23:02:21.947868",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 281272588,
      "bytes_sent": 2607626,
      "bytes_received_mb": 268.24,
      "bytes_sent_mb": 2.49
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.922 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.759 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.566 ms - 1516[0m
