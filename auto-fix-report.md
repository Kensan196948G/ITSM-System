...
```json
{
  "timestamp": "2026-02-21T20:37:23.794331",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 271816137,
      "bytes_sent": 2853794,
      "bytes_received_mb": 259.22,
      "bytes_sent_mb": 2.72
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.560 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.729 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.881 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 7.178 ms - 1516[0m
