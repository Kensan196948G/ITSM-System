...
```json
{
  "timestamp": "2026-02-28T15:44:37.513461",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 261942700,
      "bytes_sent": 2757085,
      "bytes_received_mb": 249.81,
      "bytes_sent_mb": 2.63
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.658 s)
