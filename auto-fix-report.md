...
```json
{
  "timestamp": "2026-02-28T16:43:13.144172",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 471048878,
      "bytes_sent": 3210098,
      "bytes_received_mb": 449.23,
      "bytes_sent_mb": 3.06
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.533 s)
