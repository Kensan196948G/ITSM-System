...
```json
{
  "timestamp": "2026-02-28T07:33:23.076322",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 257263750,
      "bytes_sent": 4746194,
      "bytes_received_mb": 245.35,
      "bytes_sent_mb": 4.53
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.72 s)
