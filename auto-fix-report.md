...
```json
{
  "timestamp": "2026-02-28T19:42:20.784572",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 492603982,
      "bytes_sent": 2791492,
      "bytes_received_mb": 469.78,
      "bytes_sent_mb": 2.66
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.483 s)
