...
```json
{
  "timestamp": "2026-02-20T07:49:57.565878",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 257373803,
      "bytes_sent": 2477129,
      "bytes_received_mb": 245.45,
      "bytes_sent_mb": 2.36
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.674 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.332 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.808 ms - 7282[0m
  console.log
