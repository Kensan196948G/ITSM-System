...
```json
{
  "timestamp": "2026-02-03T16:36:43.734382",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105844509,
      "bytes_sent": 698753,
      "bytes_received_mb": 100.94,
      "bytes_sent_mb": 0.67
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.705 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 23.797 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.995 ms - 1516[0m
