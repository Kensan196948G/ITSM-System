...
```json
{
  "timestamp": "2026-02-27T23:43:02.360176",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 256802734,
      "bytes_sent": 2955524,
      "bytes_received_mb": 244.91,
      "bytes_sent_mb": 2.82
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.411 s)
