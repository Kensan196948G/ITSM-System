...
```json
{
  "timestamp": "2026-03-02T03:46:43.630379",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 9.0,
      "message": "Memory usage normal: 9.0%",
      "critical": false,
      "details": {
        "total_mb": 15990,
        "used_mb": 1443,
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 743416790,
      "bytes_sent": 4499150,
      "bytes_received_mb": 708.98,
      "bytes_sent_mb": 4.29
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.288 s)
