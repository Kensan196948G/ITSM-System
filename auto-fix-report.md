...
```json
{
  "timestamp": "2026-02-23T12:01:29.363436",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 282453174,
      "bytes_sent": 2361796,
      "bytes_received_mb": 269.37,
      "bytes_sent_mb": 2.25
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.765 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.044 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.935 ms - 7279[0m
  console.log
