...
```json
{
  "timestamp": "2026-02-28T09:45:27.372541",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 717868849,
      "bytes_sent": 4486751,
      "bytes_received_mb": 684.61,
      "bytes_sent_mb": 4.28
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.499 s)
