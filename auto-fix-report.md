...
```json
{
  "timestamp": "2026-02-22T19:54:38.173794",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 282056516,
      "bytes_sent": 2322971,
      "bytes_received_mb": 268.99,
      "bytes_sent_mb": 2.22
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.514 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 20.756 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.231 ms - 1516[0m
