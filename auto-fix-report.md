...
```json
{
  "timestamp": "2026-02-09T05:04:00.212200",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140137982,
      "bytes_sent": 776014,
      "bytes_received_mb": 133.65,
      "bytes_sent_mb": 0.74
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.928 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.590 ms - 7274[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.372 ms - 1516[0m
