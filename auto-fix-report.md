...
```json
{
  "timestamp": "2026-02-24T01:21:49.775655",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 257974634,
      "bytes_sent": 2474385,
      "bytes_received_mb": 246.02,
      "bytes_sent_mb": 2.36
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.675 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.500 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.909 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.889 ms - 1516[0m
