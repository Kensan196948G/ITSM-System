...
```json
{
  "timestamp": "2026-02-21T15:49:22.471651",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 279089082,
      "bytes_sent": 2898017,
      "bytes_received_mb": 266.16,
      "bytes_sent_mb": 2.76
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.110 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.905 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.803 ms - 7280[0m
  console.log
