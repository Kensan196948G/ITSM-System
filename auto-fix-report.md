...
```json
{
  "timestamp": "2026-02-22T04:29:21.857684",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 287748601,
      "bytes_sent": 5830167,
      "bytes_received_mb": 274.42,
      "bytes_sent_mb": 5.56
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.755 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.989 ms - 7281[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.764 ms - 1516[0m
