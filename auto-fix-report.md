...
```json
{
  "timestamp": "2026-02-28T06:38:13.717363",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 704685209,
      "bytes_sent": 5124999,
      "bytes_received_mb": 672.04,
      "bytes_sent_mb": 4.89
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.757 s)
