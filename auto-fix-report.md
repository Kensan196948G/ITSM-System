...
```json
{
  "timestamp": "2026-02-03T20:02:41.580011",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 207819013,
      "bytes_sent": 2254151,
      "bytes_received_mb": 198.19,
      "bytes_sent_mb": 2.15
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 29.336 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 71.243 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 11.796 ms - 1516[0m
