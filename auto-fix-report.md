...
```json
{
  "timestamp": "2026-02-17T00:02:03.809044",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.665 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.677 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.398 ms - 7274[0m
  console.log
