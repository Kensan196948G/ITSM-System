...
```json
{
  "timestamp": "2026-02-05T09:03:04.201527",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 16.358 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 110.347 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 15.115 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    ...
    GET /api/v1/export/changes
      ✓ CSV形式で変更管理エクスポート（200） (54 ms)
    GET /api/v1/export/assets
      ✓ CSV形式で資産エクスポート（200） (25 ms)
      ✓ Excel形式で資産エクスポート（200） (126 ms)
