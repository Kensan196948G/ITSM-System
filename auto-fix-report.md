...
```json
{
  "timestamp": "2026-02-26T22:49:36.628652",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 272646647,
      "bytes_sent": 2851396,
      "bytes_received_mb": 260.02,
      "bytes_sent_mb": 2.72
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.631 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 10.384 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.124 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.264 ms - 7287[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 7.268 ms - 1516[0m
