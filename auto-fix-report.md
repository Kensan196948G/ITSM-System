...
```json
{
  "timestamp": "2026-02-24T21:58:46.786310",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 253535503,
      "bytes_sent": 1981752,
      "bytes_received_mb": 241.79,
      "bytes_sent_mb": 1.89
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.498 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.965 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.980 ms - 7281[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.137 ms - 1516[0m
