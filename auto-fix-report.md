...
```json
{
  "timestamp": "2026-02-27T21:49:33.620415",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 730744834,
      "bytes_sent": 5176374,
      "bytes_received_mb": 696.89,
      "bytes_sent_mb": 4.94
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.376 s)
