...
```json
{
  "timestamp": "2026-02-04T23:50:59.806011",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106204226,
      "bytes_sent": 1390580,
      "bytes_received_mb": 101.28,
      "bytes_sent_mb": 1.33
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.193 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.440 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 8.105 ms - 1516[0m
