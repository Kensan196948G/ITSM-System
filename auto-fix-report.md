...
```json
{
  "timestamp": "2026-02-03T22:52:30.630116",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 207595545,
      "bytes_sent": 1738191,
      "bytes_received_mb": 197.98,
      "bytes_sent_mb": 1.66
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 13.882 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 53.942 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 12.723 ms - 1516[0m
