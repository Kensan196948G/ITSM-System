...
```json
{
  "timestamp": "2026-02-21T06:40:24.723857",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 268602660,
      "bytes_sent": 2890281,
      "bytes_received_mb": 256.16,
      "bytes_sent_mb": 2.76
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.736 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.347 ms - 7278[0m
  console.log
