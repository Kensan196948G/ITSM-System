...
```json
{
  "timestamp": "2026-02-18T17:57:36.511017",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140147536,
      "bytes_sent": 983150,
      "bytes_received_mb": 133.66,
      "bytes_sent_mb": 0.94
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.929 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.430 ms - 7281[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.675 ms - 1516[0m
