...
```json
{
  "timestamp": "2026-02-03T01:59:49.916862",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106661820,
      "bytes_sent": 1022210,
      "bytes_received_mb": 101.72,
      "bytes_sent_mb": 0.97
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 13.509 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 59.973 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 18.085 ms - 1516[0m
