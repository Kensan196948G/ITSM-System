...
```json
{
  "timestamp": "2026-02-28T04:08:01.037215",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 717714781,
      "bytes_sent": 4246210,
      "bytes_received_mb": 684.47,
      "bytes_sent_mb": 4.05
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (10.115 s)
