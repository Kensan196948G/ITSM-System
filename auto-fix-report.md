...
```json
{
  "timestamp": "2026-02-27T09:50:21.780320",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 141179674,
      "bytes_sent": 1133931,
      "bytes_received_mb": 134.64,
      "bytes_sent_mb": 1.08
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.641 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.742 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.362 ms - 7279[0m
  console.log
