...
```json
{
  "timestamp": "2026-02-28T19:52:11.805198",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 719541515,
      "bytes_sent": 5556054,
      "bytes_received_mb": 686.21,
      "bytes_sent_mb": 5.3
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.177 s)
