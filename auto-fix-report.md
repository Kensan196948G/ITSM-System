...
```json
{
  "timestamp": "2026-02-25T17:03:42.527618",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 8.2,
      "message": "Memory usage normal: 8.2%",
      "critical": false,
      "details": {
        "total_mb": 15990,
        "used_mb": 1318,
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 275324156,
      "bytes_sent": 2408961,
      "bytes_received_mb": 262.57,
      "bytes_sent_mb": 2.3
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 8.325 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.595 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.825 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.735 ms - 1516[0m
