...
```json
{
  "timestamp": "2026-02-28T02:43:21.018664",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 134933876,
      "bytes_sent": 1018122,
      "bytes_received_mb": 128.68,
      "bytes_sent_mb": 0.97
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.371 s)
