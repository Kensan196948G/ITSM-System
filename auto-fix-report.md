...
```json
{
  "timestamp": "2026-02-27T13:47:19.615720",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 280409813,
      "bytes_sent": 3201419,
      "bytes_received_mb": 267.42,
      "bytes_sent_mb": 3.05
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.080 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.100 ms - 7274[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.870 ms - 1516[0m
