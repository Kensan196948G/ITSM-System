...
```json
{
  "timestamp": "2026-02-14T09:05:43.869154",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 273256849,
      "bytes_sent": 2882397,
      "bytes_received_mb": 260.6,
      "bytes_sent_mb": 2.75
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.979 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.028 ms - 7280[0m
  console.log
