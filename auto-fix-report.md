...
```json
{
  "timestamp": "2026-02-25T14:31:17.228342",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 254751376,
      "bytes_sent": 3297062,
      "bytes_received_mb": 242.95,
      "bytes_sent_mb": 3.14
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.324 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.391 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.925 ms - 1516[0m
