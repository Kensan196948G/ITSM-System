...
```json
{
  "timestamp": "2026-02-03T05:41:12.355496",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 107097398,
      "bytes_sent": 717589,
      "bytes_received_mb": 102.14,
      "bytes_sent_mb": 0.68
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 10.566 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 77.633 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 39.027 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    GET /api/v1/export/incidents
      ...
      ✓ Excel形式でインシデントエクスポート（200） (74 ms)
