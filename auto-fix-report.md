...
```json
{
  "timestamp": "2026-03-01T22:33:01.279058",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 732697619,
      "bytes_sent": 6056713,
      "bytes_received_mb": 698.75,
      "bytes_sent_mb": 5.78
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (8.871 s)
