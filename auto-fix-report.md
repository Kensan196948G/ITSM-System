...
```json
{
  "timestamp": "2026-02-10T20:51:12.750161",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140777196,
      "bytes_sent": 973645,
      "bytes_received_mb": 134.26,
      "bytes_sent_mb": 0.93
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.029 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.093 ms - 7275[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.892 ms - 1516[0m
