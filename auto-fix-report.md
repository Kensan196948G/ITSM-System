...
```json
{
  "timestamp": "2026-02-04T23:17:08.520778",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106442585,
      "bytes_sent": 1030777,
      "bytes_received_mb": 101.51,
      "bytes_sent_mb": 0.98
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 12.108 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 64.927 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 14.462 ms - 1516[0m
