...
```json
{
  "timestamp": "2026-02-17T12:13:10.009598",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139525681,
      "bytes_sent": 919526,
      "bytes_received_mb": 133.06,
      "bytes_sent_mb": 0.88
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.966 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.576 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.662 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.190 ms - 1516[0m
