...
```json
{
  "timestamp": "2026-02-19T13:33:36.259907",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 142295244,
      "bytes_sent": 1011313,
      "bytes_received_mb": 135.7,
      "bytes_sent_mb": 0.96
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.816 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.640 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.694 ms - 947[0m
  console.log
