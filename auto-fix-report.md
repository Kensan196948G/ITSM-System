...
```json
{
  "timestamp": "2026-02-08T00:06:58.743353",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140525346,
      "bytes_sent": 733371,
      "bytes_received_mb": 134.02,
      "bytes_sent_mb": 0.7
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.566 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 11.334 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.198 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.268 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 7.227 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    GET /api/v1/export/incidents
      ✓ 認証なしで401エラー (7 ms)
      ✓ CSV形式でインシデントエクスポート（200） (15 ms)
...
PASS backend/__tests__/unit/middleware/metrics.test.js
  Metrics Middleware Helpers
    ...
    ✓ metricsEndpoint returns Prometheus payload (9 ms)
