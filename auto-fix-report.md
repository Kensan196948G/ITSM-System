...
```json
{
  "timestamp": "2026-02-21T21:57:07.291798",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 256730136,
      "bytes_sent": 2151882,
      "bytes_received_mb": 244.84,
      "bytes_sent_mb": 2.05
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 9.342 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.396 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.050 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.366 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 10.308 ms - 1516[0m
