...
```json
{
  "timestamp": "2026-02-26T23:54:24.753844",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 275727045,
      "bytes_sent": 2793258,
      "bytes_received_mb": 262.95,
      "bytes_sent_mb": 2.66
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 9.853 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.127 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.984 ms - 7281[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 7.127 ms - 1516[0m
