...
```json
{
  "timestamp": "2026-03-01T22:47:31.942117",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 729102165,
      "bytes_sent": 5292336,
      "bytes_received_mb": 695.33,
      "bytes_sent_mb": 5.05
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.899 s)
