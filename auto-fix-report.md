...
```json
{
  "timestamp": "2026-03-01T09:03:02.603091",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 730313001,
      "bytes_sent": 6482570,
      "bytes_received_mb": 696.48,
      "bytes_sent_mb": 6.18
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.421 s)
