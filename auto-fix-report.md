...
```json
{
  "timestamp": "2026-02-22T21:11:01.260973",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 218848817,
      "bytes_sent": 1670884,
      "bytes_received_mb": 208.71,
      "bytes_sent_mb": 1.59
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.635 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.270 ms - 7276[0m
  console.log
