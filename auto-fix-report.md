...
```json
{
  "timestamp": "2026-02-25T12:27:44.615671",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 278816817,
      "bytes_sent": 2421372,
      "bytes_received_mb": 265.9,
      "bytes_sent_mb": 2.31
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.962 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.550 ms - 1516[0m
