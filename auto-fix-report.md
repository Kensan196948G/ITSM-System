...
```json
{
  "timestamp": "2026-02-02T01:07:39.132102",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 108123593,
      "bytes_sent": 3542827,
      "bytes_received_mb": 103.11,
      "bytes_sent_mb": 3.38
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 4.969 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 4.817 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 4.983 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.491 ms - 7283[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.153 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    GET /api/v1/export/incidents
      ✓ 認証なしで401エラー (5 ms)
      ✓ CSV形式でインシデントエクスポート（200） (11 ms)
...
Tests:       49 skipped, 828 passed, 877 total
Snapshots:   0 total
Time:        42.816 s
Ran all test suites.
