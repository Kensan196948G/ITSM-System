...
```json
{
  "timestamp": "2026-02-04T04:41:25.152775",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105809817,
      "bytes_sent": 694724,
      "bytes_received_mb": 100.91,
      "bytes_sent_mb": 0.66
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 20.457 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.445 ms - 1516[0m
