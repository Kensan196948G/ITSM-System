...
```json
{
  "timestamp": "2026-02-04T15:23:02.342269",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105667324,
      "bytes_sent": 685155,
      "bytes_received_mb": 100.77,
      "bytes_sent_mb": 0.65
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.358 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.336 ms - 7275[0m
  console.log
