...
```json
{
  "timestamp": "2026-02-04T21:50:34.119746",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105901141,
      "bytes_sent": 827353,
      "bytes_received_mb": 101.0,
      "bytes_sent_mb": 0.79
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 11.944 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 61.840 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 11.901 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    GET /api/v1/export/incidents
      ...
      ✓ Excel形式でインシデントエクスポート（200） (64 ms)
    GET /api/v1/export/vulnerabilities
      ✓ CSV形式で脆弱性エクスポート（200） (28 ms)
