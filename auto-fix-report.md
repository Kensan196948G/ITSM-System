...
```json
{
  "timestamp": "2026-02-22T14:42:07.869061",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 258246010,
      "bytes_sent": 4242238,
      "bytes_received_mb": 246.28,
      "bytes_sent_mb": 4.05
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.454 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.710 ms - 7277[0m
  console.log
