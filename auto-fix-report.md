...
```json
{
  "timestamp": "2026-03-01T20:45:07.558424",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 489225025,
      "bytes_sent": 3050844,
      "bytes_received_mb": 466.56,
      "bytes_sent_mb": 2.91
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (8.809 s)
