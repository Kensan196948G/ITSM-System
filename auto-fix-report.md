...
```json
{
  "timestamp": "2026-02-28T19:30:38.187588",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 444978772,
      "bytes_sent": 2151030,
      "bytes_received_mb": 424.36,
      "bytes_sent_mb": 2.05
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.186 s)
