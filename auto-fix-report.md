...
```json
{
  "timestamp": "2026-02-23T19:01:48.710808",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 285567966,
      "bytes_sent": 3320018,
      "bytes_received_mb": 272.34,
      "bytes_sent_mb": 3.17
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.862 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.636 ms - 7274[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.930 ms - 1516[0m
