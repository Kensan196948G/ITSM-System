...
```json
{
  "timestamp": "2026-02-16T18:01:31.983893",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139894164,
      "bytes_sent": 1422930,
      "bytes_received_mb": 133.41,
      "bytes_sent_mb": 1.36
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.735 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.836 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.530 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 7.173 ms - 1516[0m
