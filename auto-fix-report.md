...
```json
{
  "timestamp": "2026-02-22T23:27:43.002620",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 256927401,
      "bytes_sent": 1966208,
      "bytes_received_mb": 245.03,
      "bytes_sent_mb": 1.88
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.992 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.762 ms - 1516[0m
