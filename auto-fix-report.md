...
```json
{
  "timestamp": "2026-02-24T20:21:44.629525",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 145475038,
      "bytes_sent": 1065779,
      "bytes_received_mb": 138.74,
      "bytes_sent_mb": 1.02
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.055 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.648 ms - 1516[0m
