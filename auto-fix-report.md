...
```json
{
  "timestamp": "2026-02-09T17:26:35.794476",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 141024948,
      "bytes_sent": 931710,
      "bytes_received_mb": 134.49,
      "bytes_sent_mb": 0.89
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.951 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.545 ms - 7276[0m
  console.log
