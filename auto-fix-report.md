...
```json
{
  "timestamp": "2026-02-07T16:48:11.754815",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 5.8,
      "message": "Memory usage normal: 5.8%",
      "critical": false,
      "details": {
        "total_mb": 15994,
        "used_mb": 929,
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140161223,
      "bytes_sent": 820963,
      "bytes_received_mb": 133.67,
      "bytes_sent_mb": 0.78
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.343 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.583 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.350 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.745 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.838 ms - 1516[0m
