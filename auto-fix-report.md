...
```json
{
  "timestamp": "2026-02-22T00:58:58.106777",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 282407781,
      "bytes_sent": 2191683,
      "bytes_received_mb": 269.33,
      "bytes_sent_mb": 2.09
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.593 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.910 ms - 7280[0m
  console.log
