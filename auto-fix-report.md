...
```json
{
  "timestamp": "2026-02-03T07:25:04.690026",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106481987,
      "bytes_sent": 1165924,
      "bytes_received_mb": 101.55,
      "bytes_sent_mb": 1.11
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.857 ms - 7275[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 9.441 ms - 1516[0m
