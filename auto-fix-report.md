...
```json
{
  "timestamp": "2026-02-14T05:16:57.644753",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 138859025,
      "bytes_sent": 847569,
      "bytes_received_mb": 132.43,
      "bytes_sent_mb": 0.81
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.361 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.761 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.240 ms - 1516[0m
