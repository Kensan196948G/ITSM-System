...
```json
{
  "timestamp": "2026-02-20T23:17:14.555638",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 146640987,
      "bytes_sent": 1251793,
      "bytes_received_mb": 139.85,
      "bytes_sent_mb": 1.19
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.985 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.601 ms - 1516[0m
