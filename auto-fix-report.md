...
```json
{
  "timestamp": "2026-02-15T11:00:45.744633",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139427974,
      "bytes_sent": 953672,
      "bytes_received_mb": 132.97,
      "bytes_sent_mb": 0.91
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.491 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.092 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.519 ms - 1516[0m
