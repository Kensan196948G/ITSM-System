...
```json
{
  "timestamp": "2026-02-05T05:00:22.890094",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 23.389 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 76.896 ms - 7275[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 37.667 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    ...
    GET /api/v1/export/vulnerabilities
      ✓ CSV形式で脆弱性エクスポート（200） (30 ms)
      ✓ JSON形式で脆弱性エクスポート（200） (23 ms)
    GET /api/v1/export/changes
      ✓ CSV形式で変更管理エクスポート（200） (19 ms)
    GET /api/v1/export/assets
      ✓ CSV形式で資産エクスポート（200） (34 ms)
      ✓ Excel形式で資産エクスポート（200） (91 ms)
    Export with date filters
      ✓ 日付フィルタ付きでエクスポート (48 ms)
