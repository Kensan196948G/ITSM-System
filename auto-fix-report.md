...
```json
{
  "timestamp": "2026-02-27T15:52:44.599919",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 241230599,
      "bytes_sent": 2549540,
      "bytes_received_mb": 230.06,
      "bytes_sent_mb": 2.43
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.7 s)
