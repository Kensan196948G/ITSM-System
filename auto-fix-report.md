...
```json
{
  "timestamp": "2026-02-23T19:34:30.260213",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 258288792,
      "bytes_sent": 4318293,
      "bytes_received_mb": 246.32,
      "bytes_sent_mb": 4.12
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 7.720 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 8.928 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 7.019 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.261 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.829 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    ...
    GET /api/v1/export/changes
      ✓ CSV形式で変更管理エクスポート（200） (17 ms)
    GET /api/v1/export/assets
      ✓ CSV形式で資産エクスポート（200） (11 ms)
      ✓ Excel形式で資産エクスポート（200） (23 ms)
