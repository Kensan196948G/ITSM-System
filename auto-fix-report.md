...
```json
{
  "timestamp": "2026-02-04T14:57:26.263450",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105787417,
      "bytes_sent": 704127,
      "bytes_received_mb": 100.89,
      "bytes_sent_mb": 0.67
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 17.621 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 43.320 ms - 7286[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 11.931 ms - 1516[0m
