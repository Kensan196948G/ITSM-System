...
```json
{
  "timestamp": "2026-02-24T13:28:10.452519",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 218992656,
      "bytes_sent": 1793836,
      "bytes_received_mb": 208.85,
      "bytes_sent_mb": 1.71
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.476 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.341 ms - 7279[0m
  console.log
