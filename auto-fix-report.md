...
```json
{
  "timestamp": "2026-02-12T20:38:24.571349",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 138764163,
      "bytes_sent": 1059250,
      "bytes_received_mb": 132.34,
      "bytes_sent_mb": 1.01
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.411 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.324 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 22.901 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.900 ms - 1516[0m
