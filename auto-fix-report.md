...
```json
{
  "timestamp": "2026-02-20T11:12:28.787666",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 258813031,
      "bytes_sent": 2289864,
      "bytes_received_mb": 246.82,
      "bytes_sent_mb": 2.18
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.773 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.419 ms - 1516[0m
