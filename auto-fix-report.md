...
```json
{
  "timestamp": "2026-02-02T02:44:31.182257",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105393623,
      "bytes_sent": 760591,
      "bytes_received_mb": 100.51,
      "bytes_sent_mb": 0.73
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.152 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.351 ms - 7279[0m
  console.log
