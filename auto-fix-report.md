...
```json
{
  "timestamp": "2026-02-21T13:29:35.116599",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 259506786,
      "bytes_sent": 4226996,
      "bytes_received_mb": 247.48,
      "bytes_sent_mb": 4.03
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.372 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.917 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.998 ms - 7278[0m
  console.log
