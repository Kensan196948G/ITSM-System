...
```json
{
  "timestamp": "2026-03-01T16:21:00.387378",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 714952898,
      "bytes_sent": 4347965,
      "bytes_received_mb": 681.83,
      "bytes_sent_mb": 4.15
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.507 s)
