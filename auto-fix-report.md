...
```json
{
  "timestamp": "2026-02-26T10:48:31.521970",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 276530264,
      "bytes_sent": 2707146,
      "bytes_received_mb": 263.72,
      "bytes_sent_mb": 2.58
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.867 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.204 ms - 7279[0m
  console.log
