...
```json
{
  "timestamp": "2026-02-27T18:05:32.396750",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 248458790,
      "bytes_sent": 2165719,
      "bytes_received_mb": 236.95,
      "bytes_sent_mb": 2.07
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.695 s)
