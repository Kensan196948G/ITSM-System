...
```json
{
  "timestamp": "2026-02-27T13:19:52.409715",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 276266371,
      "bytes_sent": 2495690,
      "bytes_received_mb": 263.47,
      "bytes_sent_mb": 2.38
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.696 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.837 ms - 7280[0m
  console.log
