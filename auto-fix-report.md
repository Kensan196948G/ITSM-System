...
```json
{
  "timestamp": "2026-02-02T12:24:28.636902",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105744258,
      "bytes_sent": 856493,
      "bytes_received_mb": 100.85,
      "bytes_sent_mb": 0.82
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 19.599 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 62.471 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 17.549 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    GET /api/v1/export/incidents
      ...
      ✓ Excel形式でインシデントエクスポート（200） (72 ms)
