...
```json
{
  "timestamp": "2026-02-28T21:12:05.149530",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 732356370,
      "bytes_sent": 5735522,
      "bytes_received_mb": 698.43,
      "bytes_sent_mb": 5.47
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.13 s)
