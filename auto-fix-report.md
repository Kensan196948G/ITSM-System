...
```json
{
  "timestamp": "2026-02-03T15:26:36.070271",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 208314870,
      "bytes_sent": 2071842,
      "bytes_received_mb": 198.66,
      "bytes_sent_mb": 1.98
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.990 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.277 ms - 1516[0m
