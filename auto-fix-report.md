...
```json
{
  "timestamp": "2026-02-02T11:50:22.838956",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105634741,
      "bytes_sent": 673969,
      "bytes_received_mb": 100.74,
      "bytes_sent_mb": 0.64
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.286 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.968 ms - 7276[0m
  console.log
