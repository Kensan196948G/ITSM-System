...
```json
{
  "timestamp": "2026-02-08T17:41:55.860637",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 141680254,
      "bytes_sent": 2668806,
      "bytes_received_mb": 135.12,
      "bytes_sent_mb": 2.55
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.148 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.297 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.765 ms - 7277[0m
  console.log
