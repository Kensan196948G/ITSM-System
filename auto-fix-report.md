...
```json
{
  "timestamp": "2026-02-21T11:55:46.178766",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 258094165,
      "bytes_sent": 2948498,
      "bytes_received_mb": 246.14,
      "bytes_sent_mb": 2.81
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.646 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.931 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.693 ms - 1516[0m
