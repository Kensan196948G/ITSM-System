...
```json
{
  "timestamp": "2026-02-04T20:36:06.003049",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 107043578,
      "bytes_sent": 866782,
      "bytes_received_mb": 102.08,
      "bytes_sent_mb": 0.83
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.695 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 8.081 ms - 1516[0m
