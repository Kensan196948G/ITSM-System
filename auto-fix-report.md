...
```json
{
  "timestamp": "2026-02-08T11:53:13.367952",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.552 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.594 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.662 ms - 7274[0m
  console.log
