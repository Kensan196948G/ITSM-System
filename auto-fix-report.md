...
```json
{
  "timestamp": "2026-03-01T21:51:57.643364",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 474362141,
      "bytes_sent": 2930227,
      "bytes_received_mb": 452.39,
      "bytes_sent_mb": 2.79
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.438 s)
