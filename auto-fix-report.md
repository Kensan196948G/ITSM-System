...
```json
{
  "timestamp": "2026-02-21T05:55:00.940702",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 146544128,
      "bytes_sent": 1164461,
      "bytes_received_mb": 139.76,
      "bytes_sent_mb": 1.11
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.808 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.282 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.742 ms - 1516[0m
