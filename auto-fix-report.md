...
```json
{
  "timestamp": "2026-02-25T19:02:31.680789",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 245940109,
      "bytes_sent": 3900796,
      "bytes_received_mb": 234.55,
      "bytes_sent_mb": 3.72
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.341 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.545 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.219 ms - 7278[0m
  console.log
