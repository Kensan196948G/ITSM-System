...
```json
{
  "timestamp": "2026-02-23T17:59:55.535094",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 282289084,
      "bytes_sent": 2477279,
      "bytes_received_mb": 269.21,
      "bytes_sent_mb": 2.36
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.132 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.020 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.134 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.426 ms - 1516[0m
