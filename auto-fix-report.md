...
```json
{
  "timestamp": "2026-02-22T13:09:56.190431",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 219179986,
      "bytes_sent": 1850431,
      "bytes_received_mb": 209.03,
      "bytes_sent_mb": 1.76
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.448 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.973 ms - 7276[0m
  console.log
