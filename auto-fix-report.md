...
```json
{
  "timestamp": "2026-02-20T21:49:13.659771",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 273495733,
      "bytes_sent": 2474978,
      "bytes_received_mb": 260.83,
      "bytes_sent_mb": 2.36
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.245 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.724 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.363 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.522 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.833 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    GET /api/v1/export/incidents
      ...
      ✓ JSON形式でインシデントエクスポート（200） (14 ms)
      ✓ Excel形式でインシデントエクスポート（200） (54 ms)
    GET /api/v1/export/vulnerabilities
      ✓ CSV形式で脆弱性エクスポート（200） (14 ms)
      ✓ JSON形式で脆弱性エクスポート（200） (9 ms)
    GET /api/v1/export/changes
      ✓ CSV形式で変更管理エクスポート（200） (14 ms)
    GET /api/v1/export/assets
      ✓ CSV形式で資産エクスポート（200） (10 ms)
      ✓ Excel形式で資産エクスポート（200） (21 ms)
...
PASS backend/__tests__/unit/middleware/cache.test.js
  Cache Middleware
    ✓ generateCacheKey sorts query params (3 ms)
    ...
    ✓ manual invalidation and stats access are available (6 ms)
...
PASS backend/__tests__/unit/middleware/metrics.test.js
  Metrics Middleware Helpers
    ...
    ✓ metricsEndpoint returns Prometheus payload (10 ms)
