...
```json
{
  "timestamp": "2026-03-01T17:52:00.343854",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 473944207,
      "bytes_sent": 2472227,
      "bytes_received_mb": 451.99,
      "bytes_sent_mb": 2.36
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.589 s)
