...
```json
{
  "timestamp": "2026-02-28T04:39:27.613965",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 473694859,
      "bytes_sent": 2533156,
      "bytes_received_mb": 451.75,
      "bytes_sent_mb": 2.42
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.878 s)
