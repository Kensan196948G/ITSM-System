...
```json
{
  "timestamp": "2026-02-28T12:55:23.621977",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 487536971,
      "bytes_sent": 2381038,
      "bytes_received_mb": 464.95,
      "bytes_sent_mb": 2.27
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.451 s)
