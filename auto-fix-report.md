...
```json
{
  "timestamp": "2026-02-04T10:35:48.689642",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106268606,
      "bytes_sent": 1386844,
      "bytes_received_mb": 101.35,
      "bytes_sent_mb": 1.32
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.363 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.220 ms - 7278[0m
  console.log
