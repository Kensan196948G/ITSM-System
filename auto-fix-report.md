...
```json
{
  "timestamp": "2026-02-28T16:26:25.015213",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 267426519,
      "bytes_sent": 3112172,
      "bytes_received_mb": 255.04,
      "bytes_sent_mb": 2.97
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.36 s)
