...
```json
{
  "timestamp": "2026-02-28T01:06:22.699714",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 239205178,
      "bytes_sent": 2321757,
      "bytes_received_mb": 228.12,
      "bytes_sent_mb": 2.21
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (10.057 s)
