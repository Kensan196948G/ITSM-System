...
```json
{
  "timestamp": "2026-02-12T23:35:05.242947",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139220748,
      "bytes_sent": 996024,
      "bytes_received_mb": 132.77,
      "bytes_sent_mb": 0.95
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.467 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.247 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.260 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.489 ms - 1516[0m
