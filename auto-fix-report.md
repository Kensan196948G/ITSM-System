...
```json
{
  "timestamp": "2026-02-28T08:13:33.133491",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 264286911,
      "bytes_sent": 2648651,
      "bytes_received_mb": 252.04,
      "bytes_sent_mb": 2.53
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.737 s)
