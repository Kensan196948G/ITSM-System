...
```json
{
  "timestamp": "2026-02-20T22:49:03.627422",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 149909478,
      "bytes_sent": 1455430,
      "bytes_received_mb": 142.96,
      "bytes_sent_mb": 1.39
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.551 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 20.380 ms - 7278[0m
  console.log
