...
```json
{
  "timestamp": "2026-03-01T18:02:33.165633",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 720451522,
      "bytes_sent": 5455463,
      "bytes_received_mb": 687.08,
      "bytes_sent_mb": 5.2
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.325 s)
