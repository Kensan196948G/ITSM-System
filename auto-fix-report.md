...
```json
{
  "timestamp": "2026-02-04T20:55:08.448955",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106093456,
      "bytes_sent": 808989,
      "bytes_received_mb": 101.18,
      "bytes_sent_mb": 0.77
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 27.403 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 90.028 ms - 7275[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 13.346 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    GET /api/v1/export/incidents
      ...
      ✓ Excel形式でインシデントエクスポート（200） (75 ms)
    GET /api/v1/export/vulnerabilities
      ✓ CSV形式で脆弱性エクスポート（200） (21 ms)
      ✓ JSON形式で脆弱性エクスポート（200） (21 ms)
    GET /api/v1/export/changes
      ✓ CSV形式で変更管理エクスポート（200） (62 ms)
    GET /api/v1/export/assets
      ✓ CSV形式で資産エクスポート（200） (46 ms)
      ✓ Excel形式で資産エクスポート（200） (104 ms)
