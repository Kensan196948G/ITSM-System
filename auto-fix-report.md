...
```json
{
  "timestamp": "2026-02-23T09:14:50.580131",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 282989416,
      "bytes_sent": 2378646,
      "bytes_received_mb": 269.88,
      "bytes_sent_mb": 2.27
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.505 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 8.274 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.580 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 21.666 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 7.981 ms - 1516[0m
...
PASS backend/__tests__/unit/middleware/cache.test.js
  Cache Middleware
    ...
    ✓ invalidateCacheMiddleware clears matching patterns after success (6 ms)
    ✓ manual invalidation and stats access are available (3 ms)
...
PASS backend/__tests__/unit/middleware/metrics.test.js
  Metrics Middleware Helpers
    ✓ updates custom metrics without errors (11 ms)
