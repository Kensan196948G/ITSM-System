...
```json
{
  "timestamp": "2026-02-20T15:57:08.797909",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 278149883,
      "bytes_sent": 2132017,
      "bytes_received_mb": 265.26,
      "bytes_sent_mb": 2.03
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 10.322 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.820 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 7.283 ms - 1516[0m
