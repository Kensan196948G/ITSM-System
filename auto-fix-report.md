...
```json
{
  "timestamp": "2026-02-21T20:05:35.908439",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 256782552,
      "bytes_sent": 2165867,
      "bytes_received_mb": 244.89,
      "bytes_sent_mb": 2.07
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.822 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.752 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.604 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.425 ms - 1516[0m
