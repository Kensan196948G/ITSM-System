...
```json
{
  "timestamp": "2026-02-21T19:28:58.150222",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 282192766,
      "bytes_sent": 2515563,
      "bytes_received_mb": 269.12,
      "bytes_sent_mb": 2.4
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.567 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.449 ms - 7280[0m
  console.log
