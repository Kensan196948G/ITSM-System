...
```json
{
  "timestamp": "2026-02-28T17:49:58.016456",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 473579394,
      "bytes_sent": 2488202,
      "bytes_received_mb": 451.64,
      "bytes_sent_mb": 2.37
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.88 s)
