...
```json
{
  "timestamp": "2026-02-27T00:34:31.630281",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 276958556,
      "bytes_sent": 2960231,
      "bytes_received_mb": 264.13,
      "bytes_sent_mb": 2.82
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.014 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.222 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.043 ms - 7280[0m
  console.log
