...
```json
{
  "timestamp": "2026-02-28T03:30:17.795623",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 474726671,
      "bytes_sent": 3782976,
      "bytes_received_mb": 452.73,
      "bytes_sent_mb": 3.61
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.806 s)
