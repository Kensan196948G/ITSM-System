...
```json
{
  "timestamp": "2026-02-04T12:46:37.044551",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106910048,
      "bytes_sent": 644521,
      "bytes_received_mb": 101.96,
      "bytes_sent_mb": 0.61
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 15.901 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 39.407 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 14.347 ms - 1516[0m
