...
```json
{
  "timestamp": "2026-02-03T22:33:27.571582",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106698293,
      "bytes_sent": 1563371,
      "bytes_received_mb": 101.76,
      "bytes_sent_mb": 1.49
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.104 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.728 ms - 7275[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.623 ms - 1516[0m
