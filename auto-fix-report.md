...
```json
{
  "timestamp": "2026-02-28T15:55:12.016437",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 733951334,
      "bytes_sent": 4785296,
      "bytes_received_mb": 699.95,
      "bytes_sent_mb": 4.56
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.185 s)
