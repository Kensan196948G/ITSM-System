...
```json
{
  "timestamp": "2026-02-27T20:15:01.789594",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 728458985,
      "bytes_sent": 4770888,
      "bytes_received_mb": 694.71,
      "bytes_sent_mb": 4.55
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.749 s)
