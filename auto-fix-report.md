...
```json
{
  "timestamp": "2026-02-27T18:23:38.414561",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 719072669,
      "bytes_sent": 4883256,
      "bytes_received_mb": 685.76,
      "bytes_sent_mb": 4.66
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.828 s)
