...
```json
{
  "timestamp": "2026-02-28T20:35:18.482513",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 256706098,
      "bytes_sent": 2819476,
      "bytes_received_mb": 244.81,
      "bytes_sent_mb": 2.69
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.431 s)
