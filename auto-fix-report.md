...
```json
{
  "timestamp": "2026-02-03T12:24:29.380534",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106509698,
      "bytes_sent": 1193306,
      "bytes_received_mb": 101.58,
      "bytes_sent_mb": 1.14
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.657 ms - 7279[0m
  console.log
