...
```json
{
  "timestamp": "2026-02-18T11:29:17.178841",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140473850,
      "bytes_sent": 1058284,
      "bytes_received_mb": 133.97,
      "bytes_sent_mb": 1.01
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.868 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.557 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.982 ms - 7275[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.274 ms - 1516[0m
