...
```json
{
  "timestamp": "2026-03-01T10:02:44.780318",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 476785369,
      "bytes_sent": 5217255,
      "bytes_received_mb": 454.7,
      "bytes_sent_mb": 4.98
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.449 s)
