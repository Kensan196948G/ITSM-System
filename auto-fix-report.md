...
```json
{
  "timestamp": "2026-02-16T13:26:53.229786",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140843890,
      "bytes_sent": 1925788,
      "bytes_received_mb": 134.32,
      "bytes_sent_mb": 1.84
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.347 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.516 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.915 ms - 1516[0m
