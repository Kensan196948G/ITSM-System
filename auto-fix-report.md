...
```json
{
  "timestamp": "2026-02-13T00:53:43.058127",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.290 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.721 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.129 ms - 7278[0m
  console.log
