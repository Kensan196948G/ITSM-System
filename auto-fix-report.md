...
```json
{
  "timestamp": "2026-03-01T16:05:35.671722",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 724292264,
      "bytes_sent": 5438853,
      "bytes_received_mb": 690.74,
      "bytes_sent_mb": 5.19
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.77 s)
