...
```json
{
  "timestamp": "2026-02-07T04:02:10.297579",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 142264210,
      "bytes_sent": 796348,
      "bytes_received_mb": 135.67,
      "bytes_sent_mb": 0.76
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 12.961 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 33.850 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 15.255 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    ...
    GET /api/v1/export/changes
      ✓ CSV形式で変更管理エクスポート（200） (24 ms)
    GET /api/v1/export/assets
      ✓ CSV形式で資産エクスポート（200） (20 ms)
      ✓ Excel形式で資産エクスポート（200） (42 ms)
