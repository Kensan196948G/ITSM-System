...
```json
{
  "timestamp": "2026-02-05T10:12:03.095040",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 274069935,
      "bytes_sent": 2679123,
      "bytes_received_mb": 261.37,
      "bytes_sent_mb": 2.56
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.216 ms - 7274[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.971 ms - 1516[0m
