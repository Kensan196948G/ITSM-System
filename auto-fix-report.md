...
```json
{
  "timestamp": "2026-03-01T14:01:17.447517",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 473811653,
      "bytes_sent": 2565104,
      "bytes_received_mb": 451.86,
      "bytes_sent_mb": 2.45
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.152 s)
