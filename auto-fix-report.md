...
```json
{
  "timestamp": "2026-02-25T12:54:06.514519",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 275901869,
      "bytes_sent": 2239720,
      "bytes_received_mb": 263.12,
      "bytes_sent_mb": 2.14
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.838 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.579 ms - 1516[0m
