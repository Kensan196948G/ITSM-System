...
```json
{
  "timestamp": "2026-02-20T05:30:54.508274",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 284489927,
      "bytes_sent": 4304603,
      "bytes_received_mb": 271.31,
      "bytes_sent_mb": 4.11
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.871 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.839 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.049 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.335 ms - 1516[0m
