...
```json
{
  "timestamp": "2026-02-28T13:54:57.091883",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 473994517,
      "bytes_sent": 3343779,
      "bytes_received_mb": 452.04,
      "bytes_sent_mb": 3.19
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.386 s)
