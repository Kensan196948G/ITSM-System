...
```json
{
  "timestamp": "2026-02-19T07:07:40.995501",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 142151990,
      "bytes_sent": 1011196,
      "bytes_received_mb": 135.57,
      "bytes_sent_mb": 0.96
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.846 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.712 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.994 ms - 7284[0m
  console.log
