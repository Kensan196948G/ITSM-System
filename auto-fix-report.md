...
```json
{
  "timestamp": "2026-02-02T23:54:38.400686",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106379509,
      "bytes_sent": 1222467,
      "bytes_received_mb": 101.45,
      "bytes_sent_mb": 1.17
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 19.823 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 52.162 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 14.132 ms - 1516[0m
