...
```json
{
  "timestamp": "2026-02-15T10:12:32.678358",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 8.7,
      "message": "Memory usage normal: 8.7%",
      "critical": false,
      "details": {
        "total_mb": 15994,
        "used_mb": 1396,
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.456 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.208 ms - 7278[0m
  console.log
