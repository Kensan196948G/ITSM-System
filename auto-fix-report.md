...
```json
{
  "timestamp": "2026-02-22T17:50:10.184654",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 257591974,
      "bytes_sent": 2280193,
      "bytes_received_mb": 245.66,
      "bytes_sent_mb": 2.17
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.406 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.362 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.357 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.722 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.828 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    ...
    GET /api/v1/export/changes
      ✓ CSV形式で変更管理エクスポート（200） (7 ms)
    GET /api/v1/export/assets
      ✓ CSV形式で資産エクスポート（200） (7 ms)
...
PASS backend/__tests__/unit/middleware/cache.test.js
  Cache Middleware
    ...
    ✓ getTTL returns configured values or default (4 ms)
