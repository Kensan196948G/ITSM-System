...
```json
{
  "timestamp": "2026-02-21T11:15:07.386564",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 272109251,
      "bytes_sent": 2306151,
      "bytes_received_mb": 259.5,
      "bytes_sent_mb": 2.2
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.548 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.655 ms - 7275[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.768 ms - 1516[0m
