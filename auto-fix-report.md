...
```json
{
  "timestamp": "2026-02-07T10:53:50.391054",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 5.5,
      "message": "Memory usage normal: 5.5%",
      "critical": false,
      "details": {
        "total_mb": 15994,
        "used_mb": 885,
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140368807,
      "bytes_sent": 1152532,
      "bytes_received_mb": 133.87,
      "bytes_sent_mb": 1.1
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.206 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.501 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.334 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.147 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.595 ms - 1516[0m
