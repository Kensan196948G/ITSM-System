...
```json
{
  "timestamp": "2026-02-05T18:27:03.844653",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 277308992,
      "bytes_sent": 2148798,
      "bytes_received_mb": 264.46,
      "bytes_sent_mb": 2.05
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 11.653 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 71.964 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 29.499 ms - 1516[0m
