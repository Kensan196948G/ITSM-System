...
```json
{
  "timestamp": "2026-02-17T14:33:22.910865",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139481988,
      "bytes_sent": 1005422,
      "bytes_received_mb": 133.02,
      "bytes_sent_mb": 0.96
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.492 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.058 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.720 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.958 ms - 1516[0m
