...
```json
{
  "timestamp": "2026-02-04T10:15:40.492192",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105976894,
      "bytes_sent": 751455,
      "bytes_received_mb": 101.07,
      "bytes_sent_mb": 0.72
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 23.394 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 36.739 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 12.214 ms - 1516[0m
