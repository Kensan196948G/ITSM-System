...
```json
{
  "timestamp": "2026-02-19T09:55:53.754845",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 142744174,
      "bytes_sent": 1289290,
      "bytes_received_mb": 136.13,
      "bytes_sent_mb": 1.23
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.949 ms - 7282[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.890 ms - 1516[0m
