...
```json
{
  "timestamp": "2026-02-20T11:30:31.546573",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 144429212,
      "bytes_sent": 1043176,
      "bytes_received_mb": 137.74,
      "bytes_sent_mb": 0.99
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.570 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.030 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.792 ms - 1516[0m
