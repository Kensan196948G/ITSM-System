...
```json
{
  "timestamp": "2026-02-12T10:25:31.590047",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.796 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.809 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.248 ms - 947[0m
  console.log
