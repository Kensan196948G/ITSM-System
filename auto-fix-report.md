...
```json
{
  "timestamp": "2026-02-24T19:27:04.243679",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 285258536,
      "bytes_sent": 2599736,
      "bytes_received_mb": 272.04,
      "bytes_sent_mb": 2.48
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 9.323 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.957 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.410 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.317 ms - 1516[0m
