...
```json
{
  "timestamp": "2026-02-11T10:55:23.878194",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140323267,
      "bytes_sent": 812007,
      "bytes_received_mb": 133.82,
      "bytes_sent_mb": 0.77
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 7.456 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.445 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.723 ms - 7274[0m
  console.log
