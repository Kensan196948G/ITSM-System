...
```json
{
  "timestamp": "2026-02-08T10:05:17.515362",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 141160685,
      "bytes_sent": 1675106,
      "bytes_received_mb": 134.62,
      "bytes_sent_mb": 1.6
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.529 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.481 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.222 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 8.618 ms - 1516[0m
