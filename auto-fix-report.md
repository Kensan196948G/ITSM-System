...
```json
{
  "timestamp": "2026-02-28T18:50:48.857174",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 655368352,
      "bytes_sent": 4270386,
      "bytes_received_mb": 625.01,
      "bytes_sent_mb": 4.07
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.281 s)
