...
```json
{
  "timestamp": "2026-03-01T21:10:20.867188",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 267153236,
      "bytes_sent": 2391355,
      "bytes_received_mb": 254.78,
      "bytes_sent_mb": 2.28
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.555 s)
