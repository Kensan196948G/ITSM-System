...
```json
{
  "timestamp": "2026-02-28T11:32:59.300864",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 369480455,
      "bytes_sent": 1389709,
      "bytes_received_mb": 352.36,
      "bytes_sent_mb": 1.33
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.827 s)
