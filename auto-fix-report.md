...
```json
{
  "timestamp": "2026-03-01T19:49:56.058307",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 474271819,
      "bytes_sent": 3269641,
      "bytes_received_mb": 452.3,
      "bytes_sent_mb": 3.12
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.493 s)
