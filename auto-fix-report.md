...
```json
{
  "timestamp": "2026-02-21T04:01:36.317811",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 282920571,
      "bytes_sent": 2247719,
      "bytes_received_mb": 269.81,
      "bytes_sent_mb": 2.14
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.837 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 20.288 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.123 ms - 1516[0m
