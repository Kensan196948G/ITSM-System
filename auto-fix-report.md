...
```json
{
  "timestamp": "2026-02-04T17:44:39.657922",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105881280,
      "bytes_sent": 834174,
      "bytes_received_mb": 100.98,
      "bytes_sent_mb": 0.8
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 12.117 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 46.893 ms - 7282[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 20.776 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    ...
    GET /api/v1/export/assets
      ...
      ✓ Excel形式で資産エクスポート（200） (55 ms)
    Export with date filters
      ✓ 日付フィルタ付きでエクスポート (31 ms)
