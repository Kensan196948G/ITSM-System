...
```json
{
  "timestamp": "2026-02-28T22:01:37.673075",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 474023743,
      "bytes_sent": 2846637,
      "bytes_received_mb": 452.06,
      "bytes_sent_mb": 2.71
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.959 s)
