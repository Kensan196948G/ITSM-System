...
```json
{
  "timestamp": "2026-02-28T05:57:47.586718",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 473891434,
      "bytes_sent": 4550714,
      "bytes_received_mb": 451.94,
      "bytes_sent_mb": 4.34
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.956 s)
