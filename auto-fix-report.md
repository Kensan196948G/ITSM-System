...
```json
{
  "timestamp": "2026-02-27T05:33:19.427406",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 245632809,
      "bytes_sent": 3322327,
      "bytes_received_mb": 234.25,
      "bytes_sent_mb": 3.17
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 7.330 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.994 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 8.022 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 22.081 ms - 7280[0m
  console.log
