...
```json
{
  "timestamp": "2026-02-21T12:37:34.391987",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 282810850,
      "bytes_sent": 4266377,
      "bytes_received_mb": 269.71,
      "bytes_sent_mb": 4.07
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.466 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.827 ms - 7276[0m
  console.log
