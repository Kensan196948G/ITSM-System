...
```json
{
  "timestamp": "2026-03-01T16:40:20.105369",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 491211623,
      "bytes_sent": 3674333,
      "bytes_received_mb": 468.46,
      "bytes_sent_mb": 3.5
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.395 s)
