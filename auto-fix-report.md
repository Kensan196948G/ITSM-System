...
```json
{
  "timestamp": "2026-02-14T17:46:22.999098",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139700948,
      "bytes_sent": 1226541,
      "bytes_received_mb": 133.23,
      "bytes_sent_mb": 1.17
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.000 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.621 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.019 ms - 7283[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.805 ms - 1516[0m
