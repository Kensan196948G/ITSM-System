...
```json
{
  "timestamp": "2026-02-04T18:28:30.566784",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106213004,
      "bytes_sent": 1058978,
      "bytes_received_mb": 101.29,
      "bytes_sent_mb": 1.01
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.209 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.873 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.602 ms - 1516[0m
