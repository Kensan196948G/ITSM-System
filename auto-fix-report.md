...
```json
{
  "timestamp": "2026-02-22T16:12:20.422553",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 257255470,
      "bytes_sent": 2421162,
      "bytes_received_mb": 245.34,
      "bytes_sent_mb": 2.31
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.116 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.108 ms - 7277[0m
  console.log
