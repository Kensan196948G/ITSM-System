...
```json
{
  "timestamp": "2026-02-22T10:45:01.226524",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 257859674,
      "bytes_sent": 2842922,
      "bytes_received_mb": 245.91,
      "bytes_sent_mb": 2.71
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.560 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.140 ms - 7280[0m
  console.log
