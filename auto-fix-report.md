...
```json
{
  "timestamp": "2026-02-08T13:56:32.521666",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 279696632,
      "bytes_sent": 2229652,
      "bytes_received_mb": 266.74,
      "bytes_sent_mb": 2.13
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.741 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.647 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.960 ms - 7283[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.884 ms - 1516[0m
