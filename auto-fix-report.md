...
```json
{
  "timestamp": "2026-02-17T13:39:09.241558",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139690819,
      "bytes_sent": 936441,
      "bytes_received_mb": 133.22,
      "bytes_sent_mb": 0.89
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.782 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.779 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 20.794 ms - 7277[0m
  console.log
