...
```json
{
  "timestamp": "2026-02-22T09:42:57.160597",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 257427291,
      "bytes_sent": 2041391,
      "bytes_received_mb": 245.5,
      "bytes_sent_mb": 1.95
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.817 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.692 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 10.793 ms - 1516[0m
