...
```json
{
  "timestamp": "2026-02-18T05:39:34.137188",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.177 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 8.998 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.546 ms - 7280[0m
  console.log
