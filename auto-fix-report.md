...
```json
{
  "timestamp": "2026-02-28T22:45:48.776541",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 266011552,
      "bytes_sent": 3173574,
      "bytes_received_mb": 253.69,
      "bytes_sent_mb": 3.03
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.685 s)
