...
```json
{
  "timestamp": "2026-03-01T11:29:32.774100",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 720606562,
      "bytes_sent": 6288858,
      "bytes_received_mb": 687.22,
      "bytes_sent_mb": 6.0
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.41 s)
