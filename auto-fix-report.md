...
```json
{
  "timestamp": "2026-02-03T20:20:04.543217",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106142999,
      "bytes_sent": 735929,
      "bytes_received_mb": 101.23,
      "bytes_sent_mb": 0.7
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.630 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.150 ms - 7274[0m
  console.log
