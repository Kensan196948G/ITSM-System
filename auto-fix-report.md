...
```json
{
  "timestamp": "2026-02-25T21:28:34.606720",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 250409845,
      "bytes_sent": 2306938,
      "bytes_received_mb": 238.81,
      "bytes_sent_mb": 2.2
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.750 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.141 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.368 ms - 7278[0m
  console.log
