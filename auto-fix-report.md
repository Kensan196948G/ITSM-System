...
```json
{
  "timestamp": "2026-02-08T21:14:26.985344",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 275615581,
      "bytes_sent": 2876039,
      "bytes_received_mb": 262.85,
      "bytes_sent_mb": 2.74
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.159 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.914 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.473 ms - 7282[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.952 ms - 1516[0m
