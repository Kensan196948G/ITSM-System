...
```json
{
  "timestamp": "2026-02-02T07:14:31.048398",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106338544,
      "bytes_sent": 1071170,
      "bytes_received_mb": 101.41,
      "bytes_sent_mb": 1.02
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.534 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.425 ms - 1516[0m
