...
```json
{
  "timestamp": "2026-02-28T23:09:53.785281",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 369290605,
      "bytes_sent": 1330163,
      "bytes_received_mb": 352.18,
      "bytes_sent_mb": 1.27
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.445 s)
