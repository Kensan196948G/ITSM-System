...
```json
{
  "timestamp": "2026-02-20T17:22:34.467574",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 144644137,
      "bytes_sent": 1028581,
      "bytes_received_mb": 137.94,
      "bytes_sent_mb": 0.98
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.358 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.214 ms - 7281[0m
  console.log
