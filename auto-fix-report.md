...
```json
{
  "timestamp": "2026-02-03T08:04:46.912769",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 208767614,
      "bytes_sent": 3016114,
      "bytes_received_mb": 199.1,
      "bytes_sent_mb": 2.88
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.873 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.479 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.505 ms - 1516[0m
