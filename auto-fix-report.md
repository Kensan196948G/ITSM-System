...
```json
{
  "timestamp": "2026-02-25T00:03:08.258605",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 280210403,
      "bytes_sent": 3280965,
      "bytes_received_mb": 267.23,
      "bytes_sent_mb": 3.13
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.905 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.589 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.304 ms - 1516[0m
