...
```json
{
  "timestamp": "2026-03-01T18:37:11.059909",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 369597764,
      "bytes_sent": 1390820,
      "bytes_received_mb": 352.48,
      "bytes_sent_mb": 1.33
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.958 s)
