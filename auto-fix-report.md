...
```json
{
  "timestamp": "2026-02-19T12:27:44.226963",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 142142199,
      "bytes_sent": 982539,
      "bytes_received_mb": 135.56,
      "bytes_sent_mb": 0.94
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.815 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.734 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.458 ms - 1516[0m
