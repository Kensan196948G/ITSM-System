...
```json
{
  "timestamp": "2026-02-23T15:18:18.131195",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 148330793,
      "bytes_sent": 1266621,
      "bytes_received_mb": 141.46,
      "bytes_sent_mb": 1.21
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 20.765 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.649 ms - 1516[0m
