...
```json
{
  "timestamp": "2026-02-21T11:31:35.025403",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 6.0,
      "message": "Memory usage normal: 6.0%",
      "critical": false,
      "details": {
        "total_mb": 15994,
        "used_mb": 967,
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 272002958,
      "bytes_sent": 1985596,
      "bytes_received_mb": 259.4,
      "bytes_sent_mb": 1.89
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.453 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.911 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.390 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.616 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 7.151 ms - 1516[0m
...
PASS backend/__tests__/unit/middleware/metrics.test.js
  Metrics Middleware Helpers
    ✓ updates custom metrics without errors (13 ms)
