...
```json
{
  "timestamp": "2026-02-15T23:58:20.610602",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 272985031,
      "bytes_sent": 1917157,
      "bytes_received_mb": 260.34,
      "bytes_sent_mb": 1.83
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.214 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.325 ms - 1516[0m
