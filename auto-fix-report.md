...
```json
{
  "timestamp": "2026-02-28T12:29:53.449629",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 497095133,
      "bytes_sent": 3904457,
      "bytes_received_mb": 474.07,
      "bytes_sent_mb": 3.72
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.495 s)
