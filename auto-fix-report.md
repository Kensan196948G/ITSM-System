...
```json
{
  "timestamp": "2026-02-03T21:56:59.303531",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106174270,
      "bytes_sent": 690977,
      "bytes_received_mb": 101.26,
      "bytes_sent_mb": 0.66
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.429 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.577 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 8.717 ms - 1516[0m
