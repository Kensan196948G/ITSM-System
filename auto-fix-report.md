...
```json
{
  "timestamp": "2026-02-23T21:07:27.375946",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 273061966,
      "bytes_sent": 2212686,
      "bytes_received_mb": 260.41,
      "bytes_sent_mb": 2.11
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.663 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.771 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.610 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.422 ms - 1516[0m
