...
```json
{
  "timestamp": "2026-03-01T01:40:49.217936",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 719327023,
      "bytes_sent": 4233715,
      "bytes_received_mb": 686.0,
      "bytes_sent_mb": 4.04
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.791 s)
