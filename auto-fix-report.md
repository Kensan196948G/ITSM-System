...
```json
{
  "timestamp": "2026-02-28T10:26:25.198209",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 473260237,
      "bytes_sent": 2483036,
      "bytes_received_mb": 451.34,
      "bytes_sent_mb": 2.37
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.588 s)
