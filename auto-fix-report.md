...
```json
{
  "timestamp": "2026-02-20T22:13:24.794387",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 257943004,
      "bytes_sent": 2166394,
      "bytes_received_mb": 245.99,
      "bytes_sent_mb": 2.07
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 8.669 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.516 ms - 7278[0m
  console.log
