...
```json
{
  "timestamp": "2026-03-01T11:41:44.125545",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 729457782,
      "bytes_sent": 5075673,
      "bytes_received_mb": 695.67,
      "bytes_sent_mb": 4.84
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.474 s)
