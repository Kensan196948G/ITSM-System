...
```json
{
  "timestamp": "2026-02-28T08:31:32.172712",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 721288931,
      "bytes_sent": 6483227,
      "bytes_received_mb": 687.87,
      "bytes_sent_mb": 6.18
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.558 s)
