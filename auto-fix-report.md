...
```json
{
  "timestamp": "2026-03-01T23:42:41.879948",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 722491994,
      "bytes_sent": 5022009,
      "bytes_received_mb": 689.02,
      "bytes_sent_mb": 4.79
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.73 s)
