...
```json
{
  "timestamp": "2026-02-23T14:28:13.546127",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 144079635,
      "bytes_sent": 1028267,
      "bytes_received_mb": 137.41,
      "bytes_sent_mb": 0.98
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.050 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.359 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.395 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.087 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 9.680 ms - 1516[0m
