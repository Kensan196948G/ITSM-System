...
```json
{
  "timestamp": "2026-02-05T08:38:47.809018",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139391999,
      "bytes_sent": 694576,
      "bytes_received_mb": 132.93,
      "bytes_sent_mb": 0.66
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 12.310 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 45.684 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 10.997 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    ...
    GET /api/v1/export/changes
      ✓ CSV形式で変更管理エクスポート（200） (26 ms)
    GET /api/v1/export/assets
      ✓ CSV形式で資産エクスポート（200） (22 ms)
      ✓ Excel形式で資産エクスポート（200） (56 ms)
