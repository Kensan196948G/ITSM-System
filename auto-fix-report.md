...
```json
{
  "timestamp": "2026-03-01T22:15:23.583153",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 471753357,
      "bytes_sent": 2854088,
      "bytes_received_mb": 449.9,
      "bytes_sent_mb": 2.72
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.607 s)
