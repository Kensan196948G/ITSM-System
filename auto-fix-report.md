...
```json
{
  "timestamp": "2026-02-17T09:59:04.064175",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139846202,
      "bytes_sent": 896087,
      "bytes_received_mb": 133.37,
      "bytes_sent_mb": 0.85
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.119 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.765 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.169 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.683 ms - 1516[0m
