...
```json
{
  "timestamp": "2026-02-18T22:37:00.502902",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140891410,
      "bytes_sent": 1728510,
      "bytes_received_mb": 134.36,
      "bytes_sent_mb": 1.65
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.567 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.848 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.102 ms - 1516[0m
