...
```json
{
  "timestamp": "2026-02-22T01:41:13.276592",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 146369463,
      "bytes_sent": 1105967,
      "bytes_received_mb": 139.59,
      "bytes_sent_mb": 1.05
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.703 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.143 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.604 ms - 1516[0m
