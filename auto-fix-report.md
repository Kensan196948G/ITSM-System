...
```json
{
  "timestamp": "2026-02-07T01:22:00.846258",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 141034860,
      "bytes_sent": 776818,
      "bytes_received_mb": 134.5,
      "bytes_sent_mb": 0.74
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 11.005 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 47.096 ms - 7275[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 11.202 ms - 1516[0m
