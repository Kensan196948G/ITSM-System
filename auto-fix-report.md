...
```json
{
  "timestamp": "2026-03-01T13:08:51.184761",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 720043440,
      "bytes_sent": 4358857,
      "bytes_received_mb": 686.69,
      "bytes_sent_mb": 4.16
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.142 s)
