...
```json
{
  "timestamp": "2026-02-23T18:33:08.980292",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 144339818,
      "bytes_sent": 1470090,
      "bytes_received_mb": 137.65,
      "bytes_sent_mb": 1.4
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.812 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.963 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 7.233 ms - 1516[0m
