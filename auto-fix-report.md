...
```json
{
  "timestamp": "2026-02-25T19:54:00.631783",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 276574479,
      "bytes_sent": 4412309,
      "bytes_received_mb": 263.76,
      "bytes_sent_mb": 4.21
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.925 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.534 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.236 ms - 7277[0m
  console.log
