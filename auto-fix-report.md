...
```json
{
  "timestamp": "2026-02-05T21:42:30.914957",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 273152006,
      "bytes_sent": 2076330,
      "bytes_received_mb": 260.5,
      "bytes_sent_mb": 1.98
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.374 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.448 ms - 7281[0m
  console.log
