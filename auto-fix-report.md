...
```json
{
  "timestamp": "2026-02-03T19:45:46.050837",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106105765,
      "bytes_sent": 656776,
      "bytes_received_mb": 101.19,
      "bytes_sent_mb": 0.63
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.890 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 7.592 ms - 1516[0m
