...
```json
{
  "timestamp": "2026-02-21T00:47:32.426555",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 258320938,
      "bytes_sent": 2208968,
      "bytes_received_mb": 246.35,
      "bytes_sent_mb": 2.11
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.806 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.781 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.287 ms - 1516[0m
