...
```json
{
  "timestamp": "2026-02-21T08:09:37.164737",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 257211048,
      "bytes_sent": 2873339,
      "bytes_received_mb": 245.3,
      "bytes_sent_mb": 2.74
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.857 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.655 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.967 ms - 7282[0m
  console.log
