...
```json
{
  "timestamp": "2026-02-19T00:50:54.939861",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 143141499,
      "bytes_sent": 1452119,
      "bytes_received_mb": 136.51,
      "bytes_sent_mb": 1.38
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.202 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.537 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.336 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.032 ms - 7279[0m
  console.log
