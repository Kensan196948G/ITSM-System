...
```json
{
  "timestamp": "2026-02-11T22:14:24.626984",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140798160,
      "bytes_sent": 1340111,
      "bytes_received_mb": 134.28,
      "bytes_sent_mb": 1.28
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.395 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.898 ms - 7281[0m
  console.log
