...
```json
{
  "timestamp": "2026-02-08T15:35:29.621801",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140565369,
      "bytes_sent": 839353,
      "bytes_received_mb": 134.05,
      "bytes_sent_mb": 0.8
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.994 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.270 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.785 ms - 1516[0m
