...
```json
{
  "timestamp": "2026-02-28T12:11:24.843723",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 241684958,
      "bytes_sent": 2406219,
      "bytes_received_mb": 230.49,
      "bytes_sent_mb": 2.29
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (10.103 s)
