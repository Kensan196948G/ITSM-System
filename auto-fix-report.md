...
```json
{
  "timestamp": "2026-02-26T15:26:28.988645",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 253685297,
      "bytes_sent": 3582065,
      "bytes_received_mb": 241.93,
      "bytes_sent_mb": 3.42
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.431 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.585 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.353 ms - 7281[0m
  console.log
