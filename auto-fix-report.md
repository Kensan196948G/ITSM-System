...
```json
{
  "timestamp": "2026-02-15T16:30:08.044503",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139327659,
      "bytes_sent": 883388,
      "bytes_received_mb": 132.87,
      "bytes_sent_mb": 0.84
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.939 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.553 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.157 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.636 ms - 1516[0m
