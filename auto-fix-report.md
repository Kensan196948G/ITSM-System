...
```json
{
  "timestamp": "2026-02-23T05:45:02.656387",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 283117458,
      "bytes_sent": 4794073,
      "bytes_received_mb": 270.0,
      "bytes_sent_mb": 4.57
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 9.017 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.327 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 9.241 ms - 1516[0m
