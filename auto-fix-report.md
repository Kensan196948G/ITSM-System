...
```json
{
  "timestamp": "2026-02-13T11:56:23.406972",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 138802386,
      "bytes_sent": 831368,
      "bytes_received_mb": 132.37,
      "bytes_sent_mb": 0.79
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.174 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.821 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.725 ms - 7281[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.745 ms - 1516[0m
