...
```json
{
  "timestamp": "2026-02-24T04:58:00.953597",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 144283848,
      "bytes_sent": 1050350,
      "bytes_received_mb": 137.6,
      "bytes_sent_mb": 1.0
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.743 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.511 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.419 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.113 ms - 1516[0m
