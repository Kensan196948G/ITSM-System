...
```json
{
  "timestamp": "2026-02-21T17:03:36.013377",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 144486380,
      "bytes_sent": 1132717,
      "bytes_received_mb": 137.79,
      "bytes_sent_mb": 1.08
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.351 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.858 ms - 1516[0m
