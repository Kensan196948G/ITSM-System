...
```json
{
  "timestamp": "2026-03-02T16:20:28.656600",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 512925218,
      "bytes_sent": 2629926,
      "bytes_received_mb": 489.16,
      "bytes_sent_mb": 2.51
    }
  }
}
...
FAIL backend/__tests__/unit/utils/encryption.test.js
  ● Encryption Utility (AES-256-GCM) › decrypt › should throw on tampered ciphertext

    expect(received).toThrow()

    Received function did not throw

    [0m [90m 117 |[39m       [90m// Tamper with the encrypted data[39m
     [90m 118 |[39m       [36mconst[39m tampered [33m=[39m [32m`ff${encrypted.slice(2)}`[39m[33m;[39m
    [31m[1m>[22m[39m[90m 119 |[39m       expect(() [33m=>[39m decrypt(tampered[33m,[39m iv[33m,[39m authTag[33m,[39m [33mTEST_KEY[39m))[33m.[39mtoThrow()[33m;[39m
     [90m     |[39m                                                              [31m[1m^[22m[39m
     [90m 120 |[39m     })[33m;[39m
     [90m 121 |[39m
     [90m 122 |[39m     it([32m'should throw on tampered auth tag'[39m[33m,[39m () [33m=>[39m {[0m

      at Object.toThrow (backend/__tests__/unit/utils/encryption.test.js:119:62)


Test Suites: 2 failed, 84 passed, 86 total
Tests:       33 failed, 24 skipped, 2466 passed, 2523 total
Snapshots:   0 total
Time:        203.292 s
Ran all test suites.
