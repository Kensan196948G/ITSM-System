...
```json
{
  "timestamp": "2026-03-01T19:08:31.393164",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 720972520,
      "bytes_sent": 5266780,
      "bytes_received_mb": 687.57,
      "bytes_sent_mb": 5.02
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.778 s)
