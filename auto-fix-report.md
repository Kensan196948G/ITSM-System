...
```json
{
  "timestamp": "2026-02-05T19:53:41.008551",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140810688,
      "bytes_sent": 775052,
      "bytes_received_mb": 134.29,
      "bytes_sent_mb": 0.74
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.183 ms - 7286[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 9.471 ms - 1516[0m
