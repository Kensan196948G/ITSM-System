...
```json
{
  "timestamp": "2026-03-01T14:58:06.084597",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 486553897,
      "bytes_sent": 2990861,
      "bytes_received_mb": 464.01,
      "bytes_sent_mb": 2.85
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.723 s)
