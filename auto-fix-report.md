...
```json
{
  "timestamp": "2026-02-07T07:41:07.183865",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140199567,
      "bytes_sent": 764953,
      "bytes_received_mb": 133.7,
      "bytes_sent_mb": 0.73
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 9.091 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.766 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.623 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.376 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 9.089 ms - 1516[0m
