...
```json
{
  "timestamp": "2026-02-26T17:40:23.498296",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 265914709,
      "bytes_sent": 1894827,
      "bytes_received_mb": 253.6,
      "bytes_sent_mb": 1.81
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.867 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.496 ms - 1516[0m
