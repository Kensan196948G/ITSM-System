...
```json
{
  "timestamp": "2026-02-22T19:43:30.812664",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 258129494,
      "bytes_sent": 4332399,
      "bytes_received_mb": 246.17,
      "bytes_sent_mb": 4.13
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.299 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.748 ms - 1516[0m
