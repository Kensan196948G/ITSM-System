...
```json
{
  "timestamp": "2026-02-22T22:23:26.577883",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 257805845,
      "bytes_sent": 4141227,
      "bytes_received_mb": 245.86,
      "bytes_sent_mb": 3.95
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.688 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.223 ms - 7274[0m
  console.log
