...
```json
{
  "timestamp": "2026-02-13T04:29:51.349283",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139188773,
      "bytes_sent": 983978,
      "bytes_received_mb": 132.74,
      "bytes_sent_mb": 0.94
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 4.940 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.262 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.261 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.679 ms - 1516[0m
