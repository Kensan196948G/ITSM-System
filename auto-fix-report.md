...
```json
{
  "timestamp": "2026-02-03T10:08:33.986110",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106066319,
      "bytes_sent": 612311,
      "bytes_received_mb": 101.15,
      "bytes_sent_mb": 0.58
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 10.886 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 52.429 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 11.163 ms - 1516[0m
