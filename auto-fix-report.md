...
```json
{
  "timestamp": "2026-02-02T07:39:55.370541",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105698308,
      "bytes_sent": 821165,
      "bytes_received_mb": 100.8,
      "bytes_sent_mb": 0.78
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 13.171 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 59.340 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 19.098 ms - 1516[0m
