...
```json
{
  "timestamp": "2026-02-14T19:40:46.834724",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140622329,
      "bytes_sent": 2284793,
      "bytes_received_mb": 134.11,
      "bytes_sent_mb": 2.18
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.561 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.503 ms - 7283[0m
  console.log
