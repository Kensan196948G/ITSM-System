...
```json
{
  "timestamp": "2026-02-27T19:44:58.624284",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 731543849,
      "bytes_sent": 5245587,
      "bytes_received_mb": 697.65,
      "bytes_sent_mb": 5.0
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.591 s)
