...
```json
{
  "timestamp": "2026-02-27T17:50:05.853831",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 473068964,
      "bytes_sent": 2201103,
      "bytes_received_mb": 451.15,
      "bytes_sent_mb": 2.1
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.436 s)
