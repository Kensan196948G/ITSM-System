...
```json
{
  "timestamp": "2026-02-28T16:55:19.816843",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 473395270,
      "bytes_sent": 2590205,
      "bytes_received_mb": 451.46,
      "bytes_sent_mb": 2.47
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.492 s)
