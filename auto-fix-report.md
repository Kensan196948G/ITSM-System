...
```json
{
  "timestamp": "2026-02-24T06:33:04.455021",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 258779241,
      "bytes_sent": 2626887,
      "bytes_received_mb": 246.79,
      "bytes_sent_mb": 2.51
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.258 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.237 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.791 ms - 1516[0m
