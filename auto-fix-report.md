...
```json
{
  "timestamp": "2026-02-05T23:02:29.575745",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139195362,
      "bytes_sent": 824469,
      "bytes_received_mb": 132.75,
      "bytes_sent_mb": 0.79
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.315 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.944 ms - 7280[0m
  console.log
