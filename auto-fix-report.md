...
```json
{
  "timestamp": "2026-02-05T07:54:27.380081",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 274189133,
      "bytes_sent": 2435017,
      "bytes_received_mb": 261.49,
      "bytes_sent_mb": 2.32
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 26.876 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 100.362 ms - 7281[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 18.161 ms - 1516[0m
