...
```json
{
  "timestamp": "2026-03-01T17:08:27.205078",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 488429405,
      "bytes_sent": 2293663,
      "bytes_received_mb": 465.8,
      "bytes_sent_mb": 2.19
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.406 s)
