...
```json
{
  "timestamp": "2026-03-01T07:09:51.527119",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 472478673,
      "bytes_sent": 2114540,
      "bytes_received_mb": 450.59,
      "bytes_sent_mb": 2.02
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.655 s)
