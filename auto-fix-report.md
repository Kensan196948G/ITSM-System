...
```json
{
  "timestamp": "2026-02-17T08:23:20.950825",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139630411,
      "bytes_sent": 875348,
      "bytes_received_mb": 133.16,
      "bytes_sent_mb": 0.83
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.707 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.398 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.007 ms - 7276[0m
  console.log
