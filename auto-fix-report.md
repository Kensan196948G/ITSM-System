...
```json
{
  "timestamp": "2026-02-27T16:10:09.330755",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 134558632,
      "bytes_sent": 1116004,
      "bytes_received_mb": 128.33,
      "bytes_sent_mb": 1.06
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.268 s)
