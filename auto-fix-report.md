...
```json
{
  "timestamp": "2026-02-02T18:07:04.461714",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106543228,
      "bytes_sent": 1030910,
      "bytes_received_mb": 101.61,
      "bytes_sent_mb": 0.98
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 11.444 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 59.931 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 13.654 ms - 1516[0m
