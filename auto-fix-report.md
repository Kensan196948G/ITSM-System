...
```json
{
  "timestamp": "2026-02-22T14:55:56.051740",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 230000690,
      "bytes_sent": 1771602,
      "bytes_received_mb": 219.35,
      "bytes_sent_mb": 1.69
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.659 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.637 ms - 1516[0m
