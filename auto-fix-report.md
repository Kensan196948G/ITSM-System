...
```json
{
  "timestamp": "2026-02-06T20:38:39.543317",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 275809535,
      "bytes_sent": 2244103,
      "bytes_received_mb": 263.03,
      "bytes_sent_mb": 2.14
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.041 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 21.355 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.831 ms - 1516[0m
