...
```json
{
  "timestamp": "2026-02-28T20:59:16.393847",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 473203642,
      "bytes_sent": 2179168,
      "bytes_received_mb": 451.28,
      "bytes_sent_mb": 2.08
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.058 s)
