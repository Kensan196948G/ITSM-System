...
```json
{
  "timestamp": "2026-02-23T13:30:45.645073",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 144209619,
      "bytes_sent": 1099030,
      "bytes_received_mb": 137.53,
      "bytes_sent_mb": 1.05
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.821 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.508 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.927 ms - 1516[0m
