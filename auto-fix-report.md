...
```json
{
  "timestamp": "2026-02-03T11:09:43.174510",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 209890917,
      "bytes_sent": 1689426,
      "bytes_received_mb": 200.17,
      "bytes_sent_mb": 1.61
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 11.650 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 56.407 ms - 7281[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 12.962 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    ...
    GET /api/v1/export/vulnerabilities
      ...
      ✓ JSON形式で脆弱性エクスポート（200） (28 ms)
    GET /api/v1/export/changes
      ✓ CSV形式で変更管理エクスポート（200） (43 ms)
    GET /api/v1/export/assets
      ✓ CSV形式で資産エクスポート（200） (25 ms)
      ✓ Excel形式で資産エクスポート（200） (64 ms)
    Export with date filters
      ✓ 日付フィルタ付きでエクスポート (21 ms)
