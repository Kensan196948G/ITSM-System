...
```json
{
  "timestamp": "2026-02-02T16:18:51.685058",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 209060537,
      "bytes_sent": 4389957,
      "bytes_received_mb": 199.38,
      "bytes_sent_mb": 4.19
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.550 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 21.687 ms - 7280[0m
  console.log
