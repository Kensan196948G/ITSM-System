...
```json
{
  "timestamp": "2026-03-01T11:00:43.017295",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 722547971,
      "bytes_sent": 4630273,
      "bytes_received_mb": 689.08,
      "bytes_sent_mb": 4.42
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.106 s)
