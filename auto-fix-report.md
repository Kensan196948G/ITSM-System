...
```json
{
  "timestamp": "2026-02-07T20:40:41.611733",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140870817,
      "bytes_sent": 1280360,
      "bytes_received_mb": 134.34,
      "bytes_sent_mb": 1.22
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.404 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.367 ms - 7279[0m
  console.log
