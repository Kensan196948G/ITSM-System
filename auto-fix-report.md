...
```json
{
  "timestamp": "2026-02-18T01:26:24.381907",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 6.5,
      "message": "Memory usage normal: 6.5%",
      "critical": false,
      "details": {
        "total_mb": 15994,
        "used_mb": 1036,
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139966110,
      "bytes_sent": 960709,
      "bytes_received_mb": 133.48,
      "bytes_sent_mb": 0.92
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.699 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.302 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.951 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.815 ms - 7281[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.773 ms - 1516[0m
