...
```json
{
  "timestamp": "2026-03-01T05:38:05.329488",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 473857685,
      "bytes_sent": 2691819,
      "bytes_received_mb": 451.91,
      "bytes_sent_mb": 2.57
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.212 s)
