...
```json
{
  "timestamp": "2026-02-20T18:02:34.632096",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 144475488,
      "bytes_sent": 1044361,
      "bytes_received_mb": 137.78,
      "bytes_sent_mb": 1.0
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 9.540 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.085 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.099 ms - 1516[0m
