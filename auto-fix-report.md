...
```json
{
  "timestamp": "2026-02-28T01:51:24.799137",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 260187775,
      "bytes_sent": 2583612,
      "bytes_received_mb": 248.13,
      "bytes_sent_mb": 2.46
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (8.896 s)
