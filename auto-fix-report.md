...
```json
{
  "timestamp": "2026-02-02T06:15:31.299190",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106055208,
      "bytes_sent": 679923,
      "bytes_received_mb": 101.14,
      "bytes_sent_mb": 0.65
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 25.014 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 53.959 ms - 7274[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 9.596 ms - 1516[0m
