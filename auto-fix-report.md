...
```json
{
  "timestamp": "2026-02-19T00:00:48.306496",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 280197108,
      "bytes_sent": 3438860,
      "bytes_received_mb": 267.22,
      "bytes_sent_mb": 3.28
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.273 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.850 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.781 ms - 1516[0m
