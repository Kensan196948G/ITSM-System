...
```json
{
  "timestamp": "2026-02-22T20:42:41.223493",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 257642103,
      "bytes_sent": 3901880,
      "bytes_received_mb": 245.71,
      "bytes_sent_mb": 3.72
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.949 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.647 ms - 7280[0m
  console.log
