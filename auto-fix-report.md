...
```json
{
  "timestamp": "2026-02-26T02:18:06.480371",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 250893393,
      "bytes_sent": 2203005,
      "bytes_received_mb": 239.27,
      "bytes_sent_mb": 2.1
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.202 ms - 7285[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.430 ms - 1516[0m
