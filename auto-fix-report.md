...
```json
{
  "timestamp": "2026-02-02T12:49:31.260650",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105645228,
      "bytes_sent": 703657,
      "bytes_received_mb": 100.75,
      "bytes_sent_mb": 0.67
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.276 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.573 ms - 7283[0m
  console.log
