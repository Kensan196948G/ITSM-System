...
```json
{
  "timestamp": "2026-02-22T14:23:52.125743",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 283092012,
      "bytes_sent": 2617688,
      "bytes_received_mb": 269.98,
      "bytes_sent_mb": 2.5
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.177 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.056 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.613 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.250 ms - 1516[0m
