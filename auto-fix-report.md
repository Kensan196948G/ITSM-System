...
```json
{
  "timestamp": "2026-02-28T11:20:35.244964",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 731758251,
      "bytes_sent": 5529095,
      "bytes_received_mb": 697.86,
      "bytes_sent_mb": 5.27
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.373 s)
