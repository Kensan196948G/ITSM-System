...
```json
{
  "timestamp": "2026-02-03T06:56:38.491525",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 208723512,
      "bytes_sent": 1512730,
      "bytes_received_mb": 199.05,
      "bytes_sent_mb": 1.44
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.894 ms - 7274[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.877 ms - 1516[0m
