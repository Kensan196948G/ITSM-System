...
```json
{
  "timestamp": "2026-02-20T10:11:27.931722",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 282670900,
      "bytes_sent": 2625714,
      "bytes_received_mb": 269.58,
      "bytes_sent_mb": 2.5
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.863 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 9.727 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.045 ms - 947[0m
  console.log
