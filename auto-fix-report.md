...
```json
{
  "timestamp": "2026-02-08T18:15:27.992530",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140102866,
      "bytes_sent": 1126148,
      "bytes_received_mb": 133.61,
      "bytes_sent_mb": 1.07
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.456 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.819 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.781 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.639 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.333 ms - 1516[0m
...
PASS backend/__tests__/unit/middleware/cache.test.js
  Cache Middleware
    ...
    ✓ manual invalidation and stats access are available (4 ms)
