...
```json
{
  "timestamp": "2026-02-24T10:28:04.151241",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 144137067,
      "bytes_sent": 1137396,
      "bytes_received_mb": 137.46,
      "bytes_sent_mb": 1.08
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 9.774 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.690 ms - 7275[0m
  console.log
