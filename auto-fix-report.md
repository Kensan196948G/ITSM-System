...
```json
{
  "timestamp": "2026-02-27T18:46:56.351006",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 434704612,
      "bytes_sent": 1772343,
      "bytes_received_mb": 414.57,
      "bytes_sent_mb": 1.69
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (10.203 s)
