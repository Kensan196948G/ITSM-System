...
```json
{
  "timestamp": "2026-02-14T21:33:49.025446",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139449669,
      "bytes_sent": 849088,
      "bytes_received_mb": 132.99,
      "bytes_sent_mb": 0.81
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.758 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.605 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.866 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 9.385 ms - 1516[0m
