...
```json
{
  "timestamp": "2026-02-26T05:33:53.844960",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140601838,
      "bytes_sent": 1032671,
      "bytes_received_mb": 134.09,
      "bytes_sent_mb": 0.98
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.404 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.028 ms - 7282[0m
  console.log
