...
```json
{
  "timestamp": "2026-02-22T05:06:40.962212",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 282369293,
      "bytes_sent": 2333839,
      "bytes_received_mb": 269.29,
      "bytes_sent_mb": 2.23
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.987 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.775 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.370 ms - 7278[0m
  console.log
