...
```json
{
  "timestamp": "2026-03-01T06:49:35.933021",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 730934132,
      "bytes_sent": 5052635,
      "bytes_received_mb": 697.07,
      "bytes_sent_mb": 4.82
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.205 s)
