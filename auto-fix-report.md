...
```json
{
  "timestamp": "2026-02-13T12:47:23.363089",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 138820500,
      "bytes_sent": 863413,
      "bytes_received_mb": 132.39,
      "bytes_sent_mb": 0.82
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 8.397 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.545 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.438 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.280 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.873 ms - 1516[0m
