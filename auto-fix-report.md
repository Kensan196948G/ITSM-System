...
```json
{
  "timestamp": "2026-03-01T09:52:15.970605",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 488833237,
      "bytes_sent": 3123238,
      "bytes_received_mb": 466.19,
      "bytes_sent_mb": 2.98
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (8.76 s)
