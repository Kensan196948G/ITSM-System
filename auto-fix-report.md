...
```json
{
  "timestamp": "2026-03-01T15:41:55.958289",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 721948037,
      "bytes_sent": 8095566,
      "bytes_received_mb": 688.5,
      "bytes_sent_mb": 7.72
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.44 s)
