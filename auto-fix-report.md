...
```json
{
  "timestamp": "2026-02-22T00:29:54.980477",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 149223111,
      "bytes_sent": 1287421,
      "bytes_received_mb": 142.31,
      "bytes_sent_mb": 1.23
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.994 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.802 ms - 866[0m
  console.log
