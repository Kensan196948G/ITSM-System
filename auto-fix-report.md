...
```json
{
  "timestamp": "2026-02-28T16:10:05.358275",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 369198861,
      "bytes_sent": 1476531,
      "bytes_received_mb": 352.1,
      "bytes_sent_mb": 1.41
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.843 s)
