...
```json
{
  "timestamp": "2026-02-02T03:45:57.315663",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106592436,
      "bytes_sent": 1004259,
      "bytes_received_mb": 101.65,
      "bytes_sent_mb": 0.96
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.695 ms - 7273[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 10.200 ms - 1516[0m
