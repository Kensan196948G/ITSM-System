...
```json
{
  "timestamp": "2026-02-02T16:01:57.269076",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106462286,
      "bytes_sent": 803473,
      "bytes_received_mb": 101.53,
      "bytes_sent_mb": 0.77
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.172 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.652 ms - 7277[0m
  console.log
