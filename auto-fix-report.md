...
```json
{
  "timestamp": "2026-02-09T02:10:55.360992",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 141689768,
      "bytes_sent": 1034559,
      "bytes_received_mb": 135.13,
      "bytes_sent_mb": 0.99
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.541 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.094 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.004 ms - 7278[0m
  console.log
