...
```json
{
  "timestamp": "2026-02-28T17:59:11.053946",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 722052784,
      "bytes_sent": 4174084,
      "bytes_received_mb": 688.6,
      "bytes_sent_mb": 3.98
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.575 s)
