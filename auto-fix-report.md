...
```json
{
  "timestamp": "2026-02-07T09:17:30.248901",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.348 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.733 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.234 ms - 7279[0m
  console.log
