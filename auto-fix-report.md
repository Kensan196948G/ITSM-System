...
```json
{
  "timestamp": "2026-02-02T10:49:14.353651",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 11.066 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 52.091 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 18.885 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    ...
    GET /api/v1/export/assets
      ...
      ✓ Excel形式で資産エクスポート（200） (59 ms)
    Export with date filters
      ✓ 日付フィルタ付きでエクスポート (30 ms)
