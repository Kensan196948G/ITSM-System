...
```json
{
  "timestamp": "2026-02-19T21:52:39.854440",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 7.4,
      "message": "Memory usage normal: 7.4%",
      "critical": false,
      "details": {
        "total_mb": 15989,
        "used_mb": 1181,
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 283460695,
      "bytes_sent": 2902009,
      "bytes_received_mb": 270.33,
      "bytes_sent_mb": 2.77
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.803 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.995 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.485 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.718 ms - 7281[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.989 ms - 1516[0m
