...
```json
{
  "timestamp": "2026-02-20T15:38:36.497626",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 146945677,
      "bytes_sent": 1162360,
      "bytes_received_mb": 140.14,
      "bytes_sent_mb": 1.11
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.777 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.496 ms - 7279[0m
  console.log
