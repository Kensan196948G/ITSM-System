...
```json
{
  "timestamp": "2026-02-24T20:43:12.756460",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 273396655,
      "bytes_sent": 4676958,
      "bytes_received_mb": 260.73,
      "bytes_sent_mb": 4.46
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.786 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.684 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.904 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.835 ms - 1516[0m
