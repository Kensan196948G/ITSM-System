...
```json
{
  "timestamp": "2026-03-02T02:52:35.645022",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 719120154,
      "bytes_sent": 4136037,
      "bytes_received_mb": 685.81,
      "bytes_sent_mb": 3.94
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.219 s)
