...
```json
{
  "timestamp": "2026-02-22T10:10:58.454876",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 282465348,
      "bytes_sent": 3275326,
      "bytes_received_mb": 269.38,
      "bytes_sent_mb": 3.12
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 8.435 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.829 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.807 ms - 1516[0m
