...
```json
{
  "timestamp": "2026-02-15T09:23:55.337368",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140289109,
      "bytes_sent": 1782169,
      "bytes_received_mb": 133.79,
      "bytes_sent_mb": 1.7
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.884 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.869 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.657 ms - 7279[0m
  console.log
