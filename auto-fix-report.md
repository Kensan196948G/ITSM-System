...
```json
{
  "timestamp": "2026-02-07T03:12:35.502411",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 141260962,
      "bytes_sent": 1118635,
      "bytes_received_mb": 134.72,
      "bytes_sent_mb": 1.07
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 11.093 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 39.914 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 12.475 ms - 1516[0m
