...
```json
{
  "timestamp": "2026-02-15T16:12:15.537494",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 275578338,
      "bytes_sent": 1884755,
      "bytes_received_mb": 262.81,
      "bytes_sent_mb": 1.8
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.178 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.282 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.508 ms - 7279[0m
  console.log
