...
```json
{
  "timestamp": "2026-02-04T05:13:10.641642",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 210380701,
      "bytes_sent": 2179121,
      "bytes_received_mb": 200.63,
      "bytes_sent_mb": 2.08
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 12.178 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 70.105 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 22.864 ms - 1516[0m
