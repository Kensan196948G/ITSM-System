...
```json
{
  "timestamp": "2026-02-26T07:55:08.902561",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 266636634,
      "bytes_sent": 3018245,
      "bytes_received_mb": 254.28,
      "bytes_sent_mb": 2.88
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.499 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.567 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.885 ms - 7279[0m
  console.log
