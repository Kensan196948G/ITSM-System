...
```json
{
  "timestamp": "2026-02-28T08:46:59.947492",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 241897972,
      "bytes_sent": 3014001,
      "bytes_received_mb": 230.69,
      "bytes_sent_mb": 2.87
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.745 s)
