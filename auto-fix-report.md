...
```json
{
  "timestamp": "2026-02-20T09:28:16.721626",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 282427815,
      "bytes_sent": 2133449,
      "bytes_received_mb": 269.34,
      "bytes_sent_mb": 2.03
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 7.471 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.227 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.162 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.082 ms - 7274[0m
  console.log
