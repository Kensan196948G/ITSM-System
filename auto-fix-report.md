...
```json
{
  "timestamp": "2026-02-22T03:42:01.985844",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 143938636,
      "bytes_sent": 1083425,
      "bytes_received_mb": 137.27,
      "bytes_sent_mb": 1.03
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.720 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.941 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.976 ms - 7280[0m
  console.log
