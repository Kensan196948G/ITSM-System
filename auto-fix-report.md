...
```json
{
  "timestamp": "2026-02-11T04:41:04.856647",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 141827986,
      "bytes_sent": 1102169,
      "bytes_received_mb": 135.26,
      "bytes_sent_mb": 1.05
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.909 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.353 ms - 1516[0m
