...
```json
{
  "timestamp": "2026-02-23T23:56:43.174202",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 257582843,
      "bytes_sent": 2719297,
      "bytes_received_mb": 245.65,
      "bytes_sent_mb": 2.59
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.745 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.377 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.602 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.485 ms - 1516[0m
