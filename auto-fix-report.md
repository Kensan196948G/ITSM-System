...
```json
{
  "timestamp": "2026-02-05T17:31:42.911081",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139639169,
      "bytes_sent": 727204,
      "bytes_received_mb": 133.17,
      "bytes_sent_mb": 0.69
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 12.155 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 64.924 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 22.768 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    GET /api/v1/export/incidents
      ...
      ✓ Excel形式でインシデントエクスポート（200） (63 ms)
