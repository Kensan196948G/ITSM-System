...
```json
{
  "timestamp": "2026-02-24T07:56:37.391281",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 286761826,
      "bytes_sent": 4157014,
      "bytes_received_mb": 273.48,
      "bytes_sent_mb": 3.96
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.947 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.758 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.811 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.852 ms - 1516[0m
