...
```json
{
  "timestamp": "2026-02-28T05:22:04.021200",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 263754101,
      "bytes_sent": 2890596,
      "bytes_received_mb": 251.54,
      "bytes_sent_mb": 2.76
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.172 s)
