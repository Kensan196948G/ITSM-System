...
```json
{
  "timestamp": "2026-02-21T22:26:17.903312",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 273734030,
      "bytes_sent": 3469118,
      "bytes_received_mb": 261.05,
      "bytes_sent_mb": 3.31
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.532 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.777 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.670 ms - 1516[0m
