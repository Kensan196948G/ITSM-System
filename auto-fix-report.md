...
```json
{
  "timestamp": "2026-02-03T06:30:27.795974",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 210398734,
      "bytes_sent": 2585318,
      "bytes_received_mb": 200.65,
      "bytes_sent_mb": 2.47
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.338 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.153 ms - 1516[0m
