...
```json
{
  "timestamp": "2026-02-23T04:22:28.331787",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 144015200,
      "bytes_sent": 1074771,
      "bytes_received_mb": 137.34,
      "bytes_sent_mb": 1.02
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.486 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.035 ms - 7280[0m
  console.log
