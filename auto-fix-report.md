...
```json
{
  "timestamp": "2026-02-08T08:07:27.745525",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 141310108,
      "bytes_sent": 1016297,
      "bytes_received_mb": 134.76,
      "bytes_sent_mb": 0.97
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.461 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.822 ms - 1516[0m
