...
```json
{
  "timestamp": "2026-02-25T06:41:14.559011",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 277697181,
      "bytes_sent": 2296966,
      "bytes_received_mb": 264.83,
      "bytes_sent_mb": 2.19
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.779 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.766 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.211 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.996 ms - 1516[0m
