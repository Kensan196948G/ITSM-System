...
```json
{
  "timestamp": "2026-02-14T11:00:07.812957",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 138872517,
      "bytes_sent": 822609,
      "bytes_received_mb": 132.44,
      "bytes_sent_mb": 0.78
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.382 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.897 ms - 7277[0m
  console.log
