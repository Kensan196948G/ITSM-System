...
```json
{
  "timestamp": "2026-02-15T20:57:47.719737",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 275210055,
      "bytes_sent": 5042335,
      "bytes_received_mb": 262.46,
      "bytes_sent_mb": 4.81
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.705 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 8.728 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.215 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.011 ms - 1516[0m
