...
```json
{
  "timestamp": "2026-02-25T15:56:39.895454",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 269474709,
      "bytes_sent": 2355325,
      "bytes_received_mb": 256.99,
      "bytes_sent_mb": 2.25
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.322 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.980 ms - 7279[0m
  console.log
