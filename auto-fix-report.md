...
```json
{
  "timestamp": "2026-02-04T14:12:37.393746",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106932836,
      "bytes_sent": 681685,
      "bytes_received_mb": 101.98,
      "bytes_sent_mb": 0.65
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.170 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.530 ms - 1516[0m
