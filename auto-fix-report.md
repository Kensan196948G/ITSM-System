...
```json
{
  "timestamp": "2026-02-21T11:01:17.253613",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 143665017,
      "bytes_sent": 1051418,
      "bytes_received_mb": 137.01,
      "bytes_sent_mb": 1.0
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.491 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.409 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.745 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.769 ms - 1516[0m
