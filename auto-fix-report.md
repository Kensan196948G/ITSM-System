...
```json
{
  "timestamp": "2026-03-01T08:15:10.809610",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 369356402,
      "bytes_sent": 1443891,
      "bytes_received_mb": 352.25,
      "bytes_sent_mb": 1.38
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.516 s)
