...
```json
{
  "timestamp": "2026-02-10T23:04:25.531049",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 141329000,
      "bytes_sent": 1818194,
      "bytes_received_mb": 134.78,
      "bytes_sent_mb": 1.73
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.452 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.332 ms - 7278[0m
  console.log
