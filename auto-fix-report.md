...
```json
{
  "timestamp": "2026-02-26T13:38:08.289458",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 250578136,
      "bytes_sent": 2528904,
      "bytes_received_mb": 238.97,
      "bytes_sent_mb": 2.41
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.761 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.115 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.665 ms - 1516[0m
