...
```json
{
  "timestamp": "2026-02-05T17:56:44.474325",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 273104755,
      "bytes_sent": 2189345,
      "bytes_received_mb": 260.45,
      "bytes_sent_mb": 2.09
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 14.573 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 37.582 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 13.333 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    ...
    GET /api/v1/export/vulnerabilities
      ✓ CSV形式で脆弱性エクスポート（200） (58 ms)
      ✓ JSON形式で脆弱性エクスポート（200） (36 ms)
    GET /api/v1/export/changes
      ✓ CSV形式で変更管理エクスポート（200） (38 ms)
    GET /api/v1/export/assets
      ✓ CSV形式で資産エクスポート（200） (24 ms)
      ✓ Excel形式で資産エクスポート（200） (46 ms)
    Export with date filters
      ✓ 日付フィルタ付きでエクスポート (44 ms)
