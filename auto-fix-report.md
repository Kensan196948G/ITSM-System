...
```json
{
  "timestamp": "2026-02-22T13:53:13.392631",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 146983512,
      "bytes_sent": 1186833,
      "bytes_received_mb": 140.17,
      "bytes_sent_mb": 1.13
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.755 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.976 ms - 7277[0m
  console.log
