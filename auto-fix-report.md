...
```json
{
  "timestamp": "2026-02-24T04:11:53.453233",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 144633906,
      "bytes_sent": 1203562,
      "bytes_received_mb": 137.93,
      "bytes_sent_mb": 1.15
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 8.346 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.509 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.360 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.710 ms - 1516[0m
