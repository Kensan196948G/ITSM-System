...
```json
{
  "timestamp": "2026-02-24T18:29:16.208598",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 7.3,
      "message": "Memory usage normal: 7.3%",
      "critical": false,
      "details": {
        "total_mb": 15994,
        "used_mb": 1171,
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 282294020,
      "bytes_sent": 2498546,
      "bytes_received_mb": 269.22,
      "bytes_sent_mb": 2.38
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 10.317 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.100 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 7.133 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.751 ms - 7277[0m
  console.log
...
PASS backend/__tests__/unit/middleware/cache.test.js
  Cache Middleware
    ...
    ✓ cacheMiddleware caches GET responses and serves from cache (7 ms)
...
PASS backend/__tests__/unit/middleware/metrics.test.js
  Metrics Middleware Helpers
    ...
    ✓ metricsEndpoint returns Prometheus payload (5 ms)
