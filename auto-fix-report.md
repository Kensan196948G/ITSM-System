...
```json
{
  "timestamp": "2026-02-28T19:02:42.211804",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 488401190,
      "bytes_sent": 2231602,
      "bytes_received_mb": 465.78,
      "bytes_sent_mb": 2.13
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.168 s)
