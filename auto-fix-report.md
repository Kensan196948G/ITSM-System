...
```json
{
  "timestamp": "2026-03-01T07:46:09.536227",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 730382831,
      "bytes_sent": 4750414,
      "bytes_received_mb": 696.55,
      "bytes_sent_mb": 4.53
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.675 s)
