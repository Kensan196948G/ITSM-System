...
```json
{
  "timestamp": "2026-02-25T07:12:07.917045",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 281867644,
      "bytes_sent": 4977664,
      "bytes_received_mb": 268.81,
      "bytes_sent_mb": 4.75
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.023 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.635 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.664 ms - 7275[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.012 ms - 1516[0m
