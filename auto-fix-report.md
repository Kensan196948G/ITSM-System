...
```json
{
  "timestamp": "2026-02-14T21:02:04.118456",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 275186434,
      "bytes_sent": 4829427,
      "bytes_received_mb": 262.44,
      "bytes_sent_mb": 4.61
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.876 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.673 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.034 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 8.850 ms - 1516[0m
