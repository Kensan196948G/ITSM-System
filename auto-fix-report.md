...
```json
{
  "timestamp": "2026-02-04T03:07:38.713813",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106716553,
      "bytes_sent": 1465964,
      "bytes_received_mb": 101.77,
      "bytes_sent_mb": 1.4
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.134 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.627 ms - 7279[0m
  console.log
