...
```json
{
  "timestamp": "2026-02-03T08:44:40.679459",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106637664,
      "bytes_sent": 1734840,
      "bytes_received_mb": 101.7,
      "bytes_sent_mb": 1.65
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.255 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.110 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.719 ms - 1516[0m
