...
```json
{
  "timestamp": "2026-02-25T10:57:28.677916",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 281886337,
      "bytes_sent": 2504397,
      "bytes_received_mb": 268.83,
      "bytes_sent_mb": 2.39
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 7.246 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 8.524 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 7.354 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.379 ms - 7277[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 8.177 ms - 1516[0m
...
PASS backend/__tests__/unit/middleware/cache.test.js
  Cache Middleware
    ...
    ✓ manual invalidation and stats access are available (7 ms)
