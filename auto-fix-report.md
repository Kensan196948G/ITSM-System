...
```json
{
  "timestamp": "2026-02-02T13:22:20.645132",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105734454,
      "bytes_sent": 659994,
      "bytes_received_mb": 100.84,
      "bytes_sent_mb": 0.63
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 13.703 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 46.404 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 11.047 ms - 1516[0m
