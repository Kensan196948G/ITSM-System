...
```json
{
  "timestamp": "2026-02-28T18:14:13.135633",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 724367259,
      "bytes_sent": 4075973,
      "bytes_received_mb": 690.81,
      "bytes_sent_mb": 3.89
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.462 s)
