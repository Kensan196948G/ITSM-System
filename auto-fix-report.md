...
```json
{
  "timestamp": "2026-02-27T14:29:24.574094",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 250011873,
      "bytes_sent": 1832776,
      "bytes_received_mb": 238.43,
      "bytes_sent_mb": 1.75
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.865 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.482 ms - 7282[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.543 ms - 1516[0m
