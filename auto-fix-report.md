...
```json
{
  "timestamp": "2026-02-27T21:16:10.506421",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 408895769,
      "bytes_sent": 2433275,
      "bytes_received_mb": 389.95,
      "bytes_sent_mb": 2.32
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.562 s)
