...
```json
{
  "timestamp": "2026-02-09T09:30:10.495072",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 278452078,
      "bytes_sent": 2468840,
      "bytes_received_mb": 265.55,
      "bytes_sent_mb": 2.35
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.028 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.054 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.329 ms - 7276[0m
  console.log
