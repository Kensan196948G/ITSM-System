...
```json
{
  "timestamp": "2026-02-27T07:43:31.655362",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 273753730,
      "bytes_sent": 2113427,
      "bytes_received_mb": 261.07,
      "bytes_sent_mb": 2.02
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.543 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.864 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.244 ms - 1516[0m
