...
```json
{
  "timestamp": "2026-02-20T01:25:53.134953",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 285083770,
      "bytes_sent": 2386352,
      "bytes_received_mb": 271.88,
      "bytes_sent_mb": 2.28
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.670 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.123 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.078 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.504 ms - 1516[0m
