...
```json
{
  "timestamp": "2026-02-04T08:45:08.385424",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106423961,
      "bytes_sent": 804562,
      "bytes_received_mb": 101.49,
      "bytes_sent_mb": 0.77
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.540 ms - 7273[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.897 ms - 1516[0m
