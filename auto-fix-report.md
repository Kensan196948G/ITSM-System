...
```json
{
  "timestamp": "2026-02-24T19:50:56.464847",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 282397439,
      "bytes_sent": 2550766,
      "bytes_received_mb": 269.32,
      "bytes_sent_mb": 2.43
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.303 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.956 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.992 ms - 1516[0m
