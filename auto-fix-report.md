...
```json
{
  "timestamp": "2026-02-20T18:48:11.199772",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 147320302,
      "bytes_sent": 1198778,
      "bytes_received_mb": 140.5,
      "bytes_sent_mb": 1.14
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.695 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.400 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.125 ms - 7277[0m
  console.log
