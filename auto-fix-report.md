...
```json
{
  "timestamp": "2026-02-21T14:03:31.651695",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 257086206,
      "bytes_sent": 3598408,
      "bytes_received_mb": 245.18,
      "bytes_sent_mb": 3.43
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.694 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.859 ms - 1516[0m
