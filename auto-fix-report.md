...
```json
{
  "timestamp": "2026-02-22T09:07:06.356342",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 143966231,
      "bytes_sent": 1125749,
      "bytes_received_mb": 137.3,
      "bytes_sent_mb": 1.07
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 5.891 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.693 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.721 ms - 1516[0m
