...
```json
{
  "timestamp": "2026-03-01T08:50:19.971091",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 731678962,
      "bytes_sent": 5871218,
      "bytes_received_mb": 697.78,
      "bytes_sent_mb": 5.6
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.87 s)
