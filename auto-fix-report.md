...
```json
{
  "timestamp": "2026-02-06T22:58:53.589662",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 273605376,
      "bytes_sent": 1644524,
      "bytes_received_mb": 260.93,
      "bytes_sent_mb": 1.57
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.332 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.294 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.462 ms - 1516[0m
