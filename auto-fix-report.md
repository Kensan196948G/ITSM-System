...
```json
{
  "timestamp": "2026-02-28T06:58:26.356267",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 473667885,
      "bytes_sent": 2500833,
      "bytes_received_mb": 451.72,
      "bytes_sent_mb": 2.38
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.331 s)
