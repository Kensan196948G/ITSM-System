...
```json
{
  "timestamp": "2026-02-25T12:01:49.892145",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 254302462,
      "bytes_sent": 3093823,
      "bytes_received_mb": 242.52,
      "bytes_sent_mb": 2.95
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.513 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.277 ms - 7272[0m
  console.log
