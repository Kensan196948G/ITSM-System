...
```json
{
  "timestamp": "2026-02-21T21:33:12.693530",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 278479716,
      "bytes_sent": 2641080,
      "bytes_received_mb": 265.58,
      "bytes_sent_mb": 2.52
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.861 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.078 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.831 ms - 1516[0m
