...
```json
{
  "timestamp": "2026-02-28T15:31:51.381894",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 369490291,
      "bytes_sent": 1289571,
      "bytes_received_mb": 352.37,
      "bytes_sent_mb": 1.23
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.182 s)
