...
```json
{
  "timestamp": "2026-02-27T10:26:27.047246",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 141901108,
      "bytes_sent": 1171171,
      "bytes_received_mb": 135.33,
      "bytes_sent_mb": 1.12
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.021 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.525 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.053 ms - 1516[0m
