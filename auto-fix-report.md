...
```json
{
  "timestamp": "2026-02-05T19:35:09.119094",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 5.9,
      "message": "Memory usage normal: 5.9%",
      "critical": false,
      "details": {
        "total_mb": 15994,
        "used_mb": 945,
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139261354,
      "bytes_sent": 721071,
      "bytes_received_mb": 132.81,
      "bytes_sent_mb": 0.69
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 11.738 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 60.065 ms - 7275[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 14.864 ms - 1516[0m
PASS backend/__tests__/integration/export.test.js
  Export API Integration Tests
    GET /api/v1/export/incidents
      ...
      ✓ Excel形式でインシデントエクスポート（200） (61 ms)
    GET /api/v1/export/vulnerabilities
      ✓ CSV形式で脆弱性エクスポート（200） (37 ms)
      ✓ JSON形式で脆弱性エクスポート（200） (19 ms)
    GET /api/v1/export/changes
      ✓ CSV形式で変更管理エクスポート（200） (19 ms)
    GET /api/v1/export/assets
      ✓ CSV形式で資産エクスポート（200） (19 ms)
      ✓ Excel形式で資産エクスポート（200） (69 ms)
    Export with date filters
      ✓ 日付フィルタ付きでエクスポート (24 ms)
