...
```json
{
  "timestamp": "2026-02-06T05:54:42.003122",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139356020,
      "bytes_sent": 683025,
      "bytes_received_mb": 132.9,
      "bytes_sent_mb": 0.65
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.272 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.007 ms - 7281[0m
  console.log
