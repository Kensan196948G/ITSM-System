...
```json
{
  "timestamp": "2026-03-01T12:19:21.967030",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 473614622,
      "bytes_sent": 2979857,
      "bytes_received_mb": 451.67,
      "bytes_sent_mb": 2.84
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.5 s)
