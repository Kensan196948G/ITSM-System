...
```json
{
  "timestamp": "2026-02-28T21:28:25.109170",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 488926509,
      "bytes_sent": 2988811,
      "bytes_received_mb": 466.28,
      "bytes_sent_mb": 2.85
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.416 s)
