...
```json
{
  "timestamp": "2026-02-28T17:08:58.863573",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 473743590,
      "bytes_sent": 2664009,
      "bytes_received_mb": 451.8,
      "bytes_sent_mb": 2.54
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.209 s)
