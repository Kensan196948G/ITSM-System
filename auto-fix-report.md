...
```json
{
  "timestamp": "2026-02-26T01:24:06.993922",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 251397976,
      "bytes_sent": 3362678,
      "bytes_received_mb": 239.75,
      "bytes_sent_mb": 3.21
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.008 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 10.310 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.942 ms - 7277[0m
  console.log
