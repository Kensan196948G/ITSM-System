...
```json
{
  "timestamp": "2026-03-01T17:39:09.905336",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 474946796,
      "bytes_sent": 2655155,
      "bytes_received_mb": 452.94,
      "bytes_sent_mb": 2.53
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.586 s)
