...
```json
{
  "timestamp": "2026-02-21T05:32:45.966914",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 256637219,
      "bytes_sent": 2178534,
      "bytes_received_mb": 244.75,
      "bytes_sent_mb": 2.08
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.239 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.035 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 19.816 ms - 7280[0m
  console.log
