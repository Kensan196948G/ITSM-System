...
```json
{
  "timestamp": "2026-02-03T09:04:27.727814",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106304614,
      "bytes_sent": 647083,
      "bytes_received_mb": 101.38,
      "bytes_sent_mb": 0.62
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 14.333 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 52.708 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 11.884 ms - 1516[0m
