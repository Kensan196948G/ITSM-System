...
```json
{
  "timestamp": "2026-03-01T09:37:07.869689",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 730833147,
      "bytes_sent": 4264821,
      "bytes_received_mb": 696.98,
      "bytes_sent_mb": 4.07
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.455 s)
