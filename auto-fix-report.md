...
```json
{
  "timestamp": "2026-02-03T15:51:47.265811",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 106129481,
      "bytes_sent": 649021,
      "bytes_received_mb": 101.21,
      "bytes_sent_mb": 0.62
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 20.332 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 75.709 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 36.285 ms - 1516[0m
