...
```json
{
  "timestamp": "2026-03-01T19:38:15.468024",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 474627549,
      "bytes_sent": 5437636,
      "bytes_received_mb": 452.64,
      "bytes_sent_mb": 5.19
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.574 s)
