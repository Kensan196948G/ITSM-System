...
```json
{
  "timestamp": "2026-02-10T02:47:32.820653",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140567001,
      "bytes_sent": 807222,
      "bytes_received_mb": 134.06,
      "bytes_sent_mb": 0.77
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.864 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.539 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.592 ms - 7276[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.921 ms - 1516[0m
