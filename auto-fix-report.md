...
```json
{
  "timestamp": "2026-02-24T07:00:57.212907",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 289163341,
      "bytes_sent": 5113559,
      "bytes_received_mb": 275.77,
      "bytes_sent_mb": 4.88
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 7.107 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.731 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.503 ms - 7281[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.260 ms - 1516[0m
