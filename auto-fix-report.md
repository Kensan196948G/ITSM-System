...
```json
{
  "timestamp": "2026-02-03T17:31:57.952438",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105925434,
      "bytes_sent": 973045,
      "bytes_received_mb": 101.02,
      "bytes_sent_mb": 0.93
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.222 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.747 ms - 7272[0m
  console.log
