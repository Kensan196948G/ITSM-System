...
```json
{
  "timestamp": "2026-02-24T03:19:30.392867",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 273575498,
      "bytes_sent": 4501353,
      "bytes_received_mb": 260.9,
      "bytes_sent_mb": 4.29
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.675 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.737 ms - 7281[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.227 ms - 1516[0m
