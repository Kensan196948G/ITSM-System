...
```json
{
  "timestamp": "2026-02-27T03:43:30.247344",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 273248260,
      "bytes_sent": 2246963,
      "bytes_received_mb": 260.59,
      "bytes_sent_mb": 2.14
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 21.166 ms - 7276[0m
  console.log
