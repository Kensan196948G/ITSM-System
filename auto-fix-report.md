...
```json
{
  "timestamp": "2026-02-28T14:38:41.630950",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 475904009,
      "bytes_sent": 3004167,
      "bytes_received_mb": 453.86,
      "bytes_sent_mb": 2.86
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (10.076 s)
