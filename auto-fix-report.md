...
```json
{
  "timestamp": "2026-02-07T04:43:21.681424",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 141319712,
      "bytes_sent": 712706,
      "bytes_received_mb": 134.77,
      "bytes_sent_mb": 0.68
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.251 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.532 ms - 1516[0m
