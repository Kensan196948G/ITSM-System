...
```json
{
  "timestamp": "2026-02-10T12:30:42.077417",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140684234,
      "bytes_sent": 864290,
      "bytes_received_mb": 134.17,
      "bytes_sent_mb": 0.82
    }
  }
}
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.526 ms - 7282[0m
  console.log
