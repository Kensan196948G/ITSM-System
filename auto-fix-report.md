...
```json
{
  "timestamp": "2026-02-17T08:46:45.901198",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
    ...
    "memory_usage": {
      "status": "healthy",
      "usage_percent": 7.8,
      "message": "Memory usage normal: 7.8%",
      "critical": false,
      "details": {
        "total_mb": 15994,
        "used_mb": 1247,
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 140033275,
      "bytes_sent": 1168307,
      "bytes_received_mb": 133.55,
      "bytes_sent_mb": 1.11
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.440 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.131 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.224 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 18.960 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.909 ms - 1516[0m
...
PASS backend/__tests__/unit/middleware/cache.test.js
  Cache Middleware
    ...
    ✓ getTTL returns configured values or default (5 ms)
