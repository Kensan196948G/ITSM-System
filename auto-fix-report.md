...
```json
{
  "timestamp": "2026-02-22T05:35:44.988387",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 257871118,
      "bytes_sent": 3471679,
      "bytes_received_mb": 245.93,
      "bytes_sent_mb": 3.31
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 9.494 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.282 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.112 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.544 ms - 7278[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.768 ms - 1516[0m
