...
```json
{
  "timestamp": "2026-03-01T20:12:43.495638",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 488829424,
      "bytes_sent": 2312110,
      "bytes_received_mb": 466.18,
      "bytes_sent_mb": 2.2
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.672 s)
