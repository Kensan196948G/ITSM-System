...
```json
{
  "timestamp": "2026-02-16T06:15:17.634993",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 139557958,
      "bytes_sent": 833853,
      "bytes_received_mb": 133.09,
      "bytes_sent_mb": 0.8
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.710 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.681 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.840 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 5.917 ms - 1516[0m
