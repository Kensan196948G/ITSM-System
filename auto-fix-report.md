...
```json
{
  "timestamp": "2026-02-27T17:09:54.487877",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 263719469,
      "bytes_sent": 2869749,
      "bytes_received_mb": 251.5,
      "bytes_sent_mb": 2.74
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (10.024 s)
