...
```json
{
  "timestamp": "2026-03-02T01:05:56.492020",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 719674916,
      "bytes_sent": 5560065,
      "bytes_received_mb": 686.34,
      "bytes_sent_mb": 5.3
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.896 s)
