...
```json
{
  "timestamp": "2026-02-19T19:49:11.563037",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 142169673,
      "bytes_sent": 984789,
      "bytes_received_mb": 135.58,
      "bytes_sent_mb": 0.94
    }
  }
}
...
[0mGET /api/v1/export/vulnerabilities?format=json [32m200[0m 6.533 ms - 4593[0m
  console.log
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 6.595 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.503 ms - 7274[0m
  console.log
