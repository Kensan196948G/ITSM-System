...
```json
{
  "timestamp": "2026-02-21T07:54:11.011202",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 272158518,
      "bytes_sent": 2483736,
      "bytes_received_mb": 259.55,
      "bytes_sent_mb": 2.37
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 5.992 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.705 ms - 1516[0m
