...
```json
{
  "timestamp": "2026-02-04T19:40:47.527424",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 105706814,
      "bytes_sent": 947382,
      "bytes_received_mb": 100.81,
      "bytes_sent_mb": 0.9
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.292 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 15.543 ms - 7280[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 8.336 ms - 1516[0m
