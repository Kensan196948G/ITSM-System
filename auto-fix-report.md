...
```json
{
  "timestamp": "2026-02-23T12:27:04.365019",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 285240575,
      "bytes_sent": 2638333,
      "bytes_received_mb": 272.03,
      "bytes_sent_mb": 2.52
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.836 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.353 ms - 7277[0m
  console.log
