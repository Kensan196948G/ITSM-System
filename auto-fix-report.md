...
```json
{
  "timestamp": "2026-02-17T11:31:48.926911",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 141292979,
      "bytes_sent": 1061016,
      "bytes_received_mb": 134.75,
      "bytes_sent_mb": 1.01
    }
  }
}
...
[0mGET /api/v1/export/changes?format=csv [32m200[0m 6.183 ms - 866[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 17.143 ms - 7279[0m
  console.log
...
[0mGET /api/v1/export/incidents?format=csv&from=2025-01-01&to=2025-12-31 [32m200[0m 6.515 ms - 1516[0m
