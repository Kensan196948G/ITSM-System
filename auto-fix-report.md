...
```json
{
  "timestamp": "2026-02-04T11:56:25.288328",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 107349310,
      "bytes_sent": 949739,
      "bytes_received_mb": 102.38,
      "bytes_sent_mb": 0.91
    }
  }
}
...
[0mGET /api/v1/export/assets?format=csv [32m200[0m 5.372 ms - 947[0m
  console.log
...
[0mGET /api/v1/export/assets?format=xlsx [32m200[0m 16.473 ms - 7280[0m
  console.log
