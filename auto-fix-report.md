...
```json
{
  "timestamp": "2026-03-02T00:34:53.347501",
  "checks": {
    "database_connection": {
      "status": "unhealthy",
  ...
  "metrics": {
    ...
    "network": {
      "bytes_received": 731863568,
      "bytes_sent": 6215130,
      "bytes_received_mb": 697.96,
      "bytes_sent_mb": 5.93
    }
  }
}
...
FAIL backend/__tests__/performance/performance.test.js (9.292 s)
